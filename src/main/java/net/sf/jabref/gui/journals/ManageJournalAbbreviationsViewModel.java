...
argument_list|()
decl_stmt|;
DECL|method|ManageJournalAbbreviationsViewModel ()
specifier|public
name|ManageJournalAbbreviationsViewModel
parameter_list|()
block|{
...
expr_stmt|;
block|}
comment|/**      * This method shall be used to add a new journal abbreviation file to the      * set of journal abbreviation files. It basically just calls the      * {@link #openFile(File file)} method      *      * @param filePath where the new file should be written to      * @throws DuplicatedJournalFileException if journal file with same path is already open      */
DECL|method|addNewFile (String filePath)
specifier|public
name|void
name|addNewFile
parameter_list|(
...
expr_stmt|;
block|}
comment|/**      * Checks whether the file exists or if a new file should be opened.      * The file will be added to the set of journal abbreviation files.      * If the file also exists its abbreviations will be read and written      * to the abbreviations property.      *      * @param filePath to the file      * @throws DuplicatedJournalFileException if journal file with same path is already open      */
DECL|method|openFile (String filePath)
specifier|public
name|void
name|openFile
parameter_list|(
...
block|}
block|}
comment|/**      * Method to add a new abbreviation to the abbreviations list property.      * It also sets the currentAbbreviation property to the new abbreviation.      *      * @param name of the abbreviation object      * @param abbreviation of the abbreviation object      * @throws DuplicatedJournalAbbreviationException if the abbreviation already exists      */
...
block|}
block|}
comment|/**      * Method to change the currentAbbrevaition property to a new abbreviation.      *      * @param name of the abbreviation object      * @param abbreviation of the abbreviation object      * @throws EmptyFieldException if either the name or the abbreviation is empty      * @throws DuplicatedJournalAbbreviationException if the abbreviation already exists      */
...
block|}
block|}
comment|/**      * Sets the name and the abbreviation of the {@code currentAbbreviation} property      * to the values of the {@code abbreviationsName} and {@code abbreviationsAbbreviation}      * properties.      *      * @throws EmptyFieldException if either the name or the abbreviation is empty      */
...
name|EmptyFieldException
argument_list|(
literal|"Abbrevaition can not be empty"
argument_list|)
throw|;
block|}
name|currentAbbreviation
...
block|}
block|}
comment|/**      * This method first saves all external files to its internal list, then writes all abbreviations      * to their files and finally updates the abbreviations auto complete. It basically calls      * {@link #saveExternalFilesList()}, {@link #saveJournalAbbreviationFiles() }and finally      * {@link #updateAbbreviationsAutoComplete()}.      */
