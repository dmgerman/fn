...
argument_list|()
expr_stmt|;
name|loadListsInBackground
argument_list|()
expr_stmt|;
block|}
DECL|method|loadListsInBackground ()
specifier|private
name|void
name|loadListsInBackground
parameter_list|()
...
argument_list|()
block|{
block|@Override             protected void updateItem(Boolean isPseudoAbbreviation
argument_list|,
name|boolean
name|isEmpty
argument_list|)
...
begin_function
DECL|method|showErrorDialog (JabRefException e)
specifier|private
name|void
name|showErrorDialog
parameter_list|(
...
annotation|@
name|FXML
DECL|method|saveAbbreviations ()
specifier|private
name|void
name|saveAbbreviations
parameter_list|()
block|{
name|Task
argument_list|<
