...
return|;
block|}
comment|/**      * Return a button which allows to go to the parent entry of the crossref field      * @param fieldEditor The FieldEditor component to get the entry key from      * @param panel The current BasePanel      * @return      */
DECL|method|getCrossrefExtraComponent (FieldEditor fieldEditor, BasePanel panel)
specifier|public
specifier|static
name|Optional
argument_list|<
name|JComponent
argument_list|>
name|getCrossrefExtraComponent
parameter_list|(
name|FieldEditor
name|fieldEditor
parameter_list|,
