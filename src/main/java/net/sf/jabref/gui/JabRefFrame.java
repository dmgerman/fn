...
return|;
block|}
DECL|method|getUniquePathPart (int panelId)
specifier|private
name|String
name|getUniquePathPart
parameter_list|(
name|int
name|panelId
parameter_list|)
...
block|}
block|}
DECL|method|hasDuplicateDatabaseFileNames ()
specifier|private
name|boolean
name|hasDuplicateDatabaseFileNames
parameter_list|()
block|{
name|List
argument_list|<
...
name|command
decl_stmt|;
DECL|method|EditAction (String command, String name, Icon icon)
specifier|public
name|EditAction
parameter_list|(
name|String
