...
block|}
block|}
DECL|class|StartStopListSortAction
specifier|private
specifier|static
class|class
name|StartStopListSortAction
block|{
DECL|field|active
specifier|private
specifier|final
...
name|list
decl_stmt|;
DECL|method|StartStopListSortAction (SortedList<BibEntry> list, Comparator<BibEntry> active)
specifier|private
name|StartStopListSortAction
parameter_list|(
name|SortedList
...
expr_stmt|;
block|}
DECL|method|update (Comparator<BibEntry> comparator)
specifier|private
name|void
name|update
parameter_list|(
