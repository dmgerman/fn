...
expr_stmt|;
block|}
comment|/*         FIXME: import selectors         if (importSelectorWords) {              for (String s : meta) {                 if (s.startsWith(MetaData.SELECTOR_META_PREFIX)) {                     panel.getBibDatabaseContext().getMetaData().putData(s, meta.getData(s));                 }             }         }*/
name|ce
operator|.
name|end
argument_list|()
