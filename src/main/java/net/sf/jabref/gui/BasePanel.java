...
argument_list|)
expr_stmt|;
comment|//when you modify this action be sure to adjust Actions.DELETE
...
block|}
decl_stmt|;
comment|/**          * Only access when you have the lock of the task instance          *          * Guarded by "task"          */
...
expr_stmt|;
block|}
DECL|method|scheduleUpdate ()
specifier|private
name|void
name|scheduleUpdate
parameter_list|()
block|{
comment|// This is a quickfix/dirty hack.
comment|// a better solution would be using RxJava or something reactive instead
comment|// nevertheless it works correctly
...
begin_comment
comment|/**      * This method selects the given entry (searches from the back), and scrolls it into view in the table.      * If an entryEditor is shown, it is given focus afterwards.      */
end_comment

begin_function
DECL|method|highlightLastEntry (final BibEntry bibEntry)
specifier|public
name|void
name|highlightLastEntry
parameter_list|(
