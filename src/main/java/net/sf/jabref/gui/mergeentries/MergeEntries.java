...
comment|// headingLabels[0].setPreferredSize(new Dimension(maxLabelWidth, headingLabels[0].getPreferredSize().height));
name|mainLayout
operator|.
name|setColumnSpec
argument_list|(
