...
DECL|method|openNewSharedDatabaseTab (DBMSConnectionProperties dbmsConnectionProperties, boolean raiseTab)
specifier|private
name|void
...
expr_stmt|;
block|}
comment|/**      * Opens a new shared database tab with the given {@link DBMSConnectionProperties}.      *      * @param dbmsConnectionProperties Connection data      */
...
expr_stmt|;
block|}
comment|/**      * Opens a new shared database tab with the already set {@link DBMSConnectionProperties}.      *      * @param raiseTab If<code>true</code> the new tab gets selected.      */
DECL|method|openLastSharedDatabaseTab (boolean raiseTab)
specifier|public
name|void
name|openLastSharedDatabaseTab
parameter_list|(
name|boolean
name|raiseTab
parameter_list|)
