...
expr_stmt|;
block|}
DECL|method|setSourceView (BibtexEntry one, BibtexEntry two, BibtexEntry three)
specifier|private
name|void
name|setSourceView
parameter_list|(
...
block|{         }
block|}
DECL|method|setEntries (BibtexEntry newOne, BibtexEntry newTwo, BibtexEntry newThree)
specifier|public
name|void
name|setEntries
parameter_list|(
