...
DECL|method|hasAllRequiredFields (BibEntry entry, BibDatabase database)
specifier|public
specifier|static
name|boolean
...
return|;
block|}
comment|/**      * Gets the display name for the specified type.      */
DECL|method|getDisplayNameFor (String type)
specifier|public
specifier|static
name|String
