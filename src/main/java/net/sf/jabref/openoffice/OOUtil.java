...
literal|1
decl_stmt|;
DECL|field|FORMAT_SMALLCAPS
specifier|private
specifier|static
specifier|final
name|int
name|FORMAT_SMALLCAPS
init|=
literal|2
decl_stmt|;
DECL|field|FORMAT_SUPERSCRIPT
specifier|private
specifier|static
specifier|final
name|int
...
literal|5
decl_stmt|;
DECL|field|FORMAT_STRIKEOUT
specifier|private
specifier|static
specifier|final
name|int
name|FORMAT_STRIKEOUT
init|=
literal|6
decl_stmt|;
DECL|field|FORMAT_MONOSPACE
specifier|private
specifier|static
specifier|final
name|int
name|FORMAT_MONOSPACE
init|=
literal|7
decl_stmt|;
DECL|field|HTML_TAG
...
expr_stmt|;
block|}
DECL|method|insertTextAtCurrentLocation (XText text, XTextCursor cursor, String string, BitSet formatting)
specifier|public
specifier|static
name|void
name|insertTextAtCurrentLocation
...
comment|/*         if (formatting.get(FORMAT_MONOSPACE)) {             xCursorProps.setPropertyValue("CharFontPitch",                             com.sun.star.awt.FontPitch.FIXED);         }         else {             xCursorProps.setPropertyValue("CharFontPitch",                             com.sun.star.awt.FontPitch.VARIABLE);         } */
if|if
condition|(
name|formatting
operator|.
