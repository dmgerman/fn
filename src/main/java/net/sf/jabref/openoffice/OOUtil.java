...
expr_stmt|;
block|}
DECL|method|insertTextAtCurrentLocation (XText text, XTextCursor cursor, String string, boolean bold, boolean italic, boolean monospace, boolean smallCaps, boolean superscript, boolean subscript, boolean underline, boolean strikeout)
specifier|public
specifier|static
name|void
name|insertTextAtCurrentLocation
