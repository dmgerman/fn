...
return|;
block|}
comment|/**      * Utility method for processing DML with proper output      *      * @param out The output object to which the DML should be sent      * @param dml The DML statements to be processed      */
...
name|error
argument_list|(
literal|"Cannot process the query "
operator|+
name|dml
operator|+
literal|" on the given output"
argument_list|)
expr_stmt|;
block|}
block|}
...
expr_stmt|;
block|}
comment|/**      * Utility method for processing DML with proper output      *      * @param out The output PrintStream to which the DML should be sent      * @param dml The DML statements to be processed      */
DECL|method|processQuery (PrintStream out, String dml)
specifier|public
specifier|static
name|void
name|processQuery
