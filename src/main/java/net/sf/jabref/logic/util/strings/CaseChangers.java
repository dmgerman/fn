...
function_decl|;
block|}
DECL|interface|WordConversionInterface
interface|interface
name|WordConversionInterface
block|{
comment|/**          * @param word The current Word          * @param curWordIndex the index of the current word (0..totalWordCount-1)          * @param totalWordCount the number of total words          * @return the converted word          */
DECL|method|doWordConversion (final String word, final int curWordIndex, int totalWordCount)
name|String
name|doWordConversion
parameter_list|(
specifier|final
name|String
name|word
...
function_decl|;
block|}
DECL|method|doConversion (final String input, WordConversionInterface converter)
specifier|private
specifier|static
name|String
name|doConversion
...
argument_list|)
decl_stmt|;
comment|// create result array without content
name|String
index|[]
name|result
init|=
...
index|]
decl_stmt|;
comment|// iterate over all words
for|for
control|(
name|int
name|i
...
block|}
block|}
comment|// create an return result
return|return
name|StringUtil
operator|.
name|join
...
operator|)
decl_stmt|;
comment|// first word and last word are always capitalized
if|if
condition|(
name|isFirstWord
operator|||
