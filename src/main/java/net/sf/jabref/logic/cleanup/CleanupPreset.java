...
name|CLEAN_UP_DOI
block|,
DECL|enumConstant|CLEAN_UP_MONTH
name|CLEAN_UP_MONTH
block|,
DECL|enumConstant|CLEAN_UP_PAGE_NUMBERS
name|CLEAN_UP_PAGE_NUMBERS
block|,
comment|/**          * Format dates correctly (yyyy-mm-dd or yyyy-mm)          */
DECL|enumConstant|CLEAN_UP_DATE
name|CLEAN_UP_DATE
block|,
...
DECL|enumConstant|CONVERT_HTML_TO_LATEX
name|CONVERT_HTML_TO_LATEX
block|,
comment|/**          * Adds curly brackets {} around keywords          */
DECL|enumConstant|CONVERT_CASE
name|CONVERT_CASE
block|,
DECL|enumConstant|CONVERT_LATEX
name|CONVERT_LATEX
block|,
DECL|enumConstant|CONVERT_UNITS
name|CONVERT_UNITS
block|,
