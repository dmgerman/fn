...
decl_stmt|;
DECL|method|RenamePdfCleanup (boolean onlyRelativePaths, BibDatabaseContext databaseContext, String fileNamePattern, String fileDirPattern, LayoutFormatterPreferences prefs, FileDirectoryPreferences fileDirectoryPreferences)
specifier|public
name|RenamePdfCleanup
parameter_list|(
name|boolean
...
name|error
argument_list|(
literal|"Could no create target necessary target directoires for renaming"
argument_list|,
name|e
argument_list|)
expr_stmt|;
