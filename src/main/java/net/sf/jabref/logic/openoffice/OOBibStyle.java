...
argument_list|)
decl_stmt|;
DECL|method|OOBibStyle (File styleFile, JabRefPreferences prefs, JournalAbbreviationLoader repositoryLoader, Charset encoding)
specifier|public
name|OOBibStyle
parameter_list|(
name|File
...
expr_stmt|;
block|}
DECL|method|OOBibStyle (String resourcePath, JabRefPreferences prefs, JournalAbbreviationLoader repositoryLoader)
specifier|public
name|OOBibStyle
parameter_list|(
name|String
