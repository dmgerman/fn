...
name|caseSensitive
decl_stmt|;
DECL|method|RegExpSearchRule (boolean caseSensitive)
specifier|public
name|RegExpSearchRule
parameter_list|(
name|boolean
...
return|;
block|}
DECL|method|compileSearchString (String searchString)
specifier|private
name|Pattern
name|compileSearchString
parameter_list|(
