...
argument_list|()
expr_stmt|;
comment|//CellConstraints cc = new CellConstraints();
comment|//builderAll.add(builderBP.getPanel(), cc.xyw(builderAll.getColumn(),
comment|//                builderAll.getRow(), 5, "center, fill"));
name|Container
name|cp
init|=
name|getContentPane
