...
return|;
block|}
comment|/**      * Compares to String lists regardless of the internal sorting      * - clones the Lists internally to be able to sort them without side effects      *      * @param fieldList1 first list of Strings      * @param fieldList2 second list of Strings      * @return returns true if both lists have the same length and all entries of the first list are contained in the      *                      second list (independent of the internal order)      */
DECL|method|checkEqualityOfLists (List<String> fieldList1, List<String> fieldList2)
specifier|private
specifier|static
name|boolean
name|checkEqualityOfLists
