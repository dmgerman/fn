...
block|}
decl_stmt|;
comment|/**      * This type is provided as an emergency choice if the user makes      * customization changes that remove the type of an entry.      *      * TODO: internal type, merge with @Other?      */
DECL|field|TYPELESS
specifier|public
specifier|static
specifier|final
