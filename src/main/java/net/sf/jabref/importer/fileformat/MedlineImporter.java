...
begin_comment
comment|/**  * Importer for the Medline/Pubmed format.  *  * check here for details on the format  * https://www.nlm.nih.gov/bsd/licensee/elements_descriptions.html  */
end_comment
...
name|newInstance
argument_list|(
literal|"net.sf.jabref.importer.fileformat.medline"
argument_list|)
decl_stmt|;
name|XMLInputFactory
name|xmlInputFactory
