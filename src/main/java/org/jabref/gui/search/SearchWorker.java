...
condition|)
block|{
comment|/*for (int i = 0; i< basePanel.getMainTable().getRowCount(); i++) {                     BibEntry entry = basePanel.getMainTable().getEntryAt(i);                     if (entry.isSearchHit()) {                         basePanel.getMainTable().setSelected(i);                         break;                     }                 }                 */
block|}
block|}
name|globalSearchBar
operator|.
