...
argument_list|)
expr_stmt|;
comment|//Add a delay of SEARCH_DELAY milliseconds before starting search
name|Timer
name|searchTask
init|=
name|FxTimer
...
condition|)
block|{
comment|// Clear search bar and select first entry, if available
case|case
name|KeyEvent
operator|.
name|VK_ESCAPE
...
block|}
block|}
comment|/**          * Clears the search bar and select first entry, if available          */
DECL|method|clearOnEsc ()
specifier|private
name|void
name|clearOnEsc
parameter_list|()
