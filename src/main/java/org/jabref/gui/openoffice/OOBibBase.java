...
name|dialogService
decl_stmt|;
DECL|method|OOBibBase (List<URL> jarUrls, boolean atEnd, DialogService dialogService)
specifier|public
name|OOBibBase
parameter_list|(
name|List
...
argument_list|)
decl_stmt|;
comment|//this whole method is part of a background task when autodecting instances, so we need to show dialog in FX thread
name|Optional
argument_list|<
name|DocumentTitleViewModel
argument_list|>
...
return|;
block|}
DECL|method|getDocumentTitle (XTextDocument doc)
specifier|private
name|Optional
argument_list|<
name|String
...
return|;
block|}
DECL|method|simpleBootstrap (List<URL> jarUrls)
specifier|private
name|XDesktop
name|simpleBootstrap
parameter_list|(
...
name|loPath
init|=
literal|"C:\\Program Files\\LibreOffice\\program"
decl_stmt|;
...
block|}
block|}
DECL|class|DocumentTitleViewModel
specifier|private
class|class
name|DocumentTitleViewModel
block|{
DECL|field|xTextDocument
specifier|private
specifier|final
name|XTextDocument
name|xTextDocument
...
name|description
decl_stmt|;
DECL|method|DocumentTitleViewModel (XTextDocument xTextDocument)
specifier|public
name|DocumentTitleViewModel
parameter_list|(
name|XTextDocument
