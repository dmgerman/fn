...
begin_comment
comment|/**  * Tools for automatically detecting OpenOffice and/or LibreOffice installations.  */
end_comment
...
block|}
block|}
DECL|method|checkAndSelectAmongMultipleInstalls (List<Path> sofficeFiles)
specifier|private
name|Optional
argument_list|<
name|File
