...
begin_class
DECL|class|JabRefDialogService
specifier|public
class|class
...
name|DialogService
block|{
comment|// Snackbar dialog maximum size
DECL|field|DIALOG_SIZE_LIMIT
specifier|public
specifier|static
specifier|final
name|int
name|DIALOG_SIZE_LIMIT
init|=
literal|300
decl_stmt|;
...
name|statusLine
decl_stmt|;
DECL|method|JabRefDialogService (Window mainWindow, Pane mainPane)
specifier|public
name|JabRefDialogService
parameter_list|(
name|Window
...
return|;
block|}
DECL|method|shortenDialogMessage (String dialogMessage)
specifier|public
specifier|static
name|String
