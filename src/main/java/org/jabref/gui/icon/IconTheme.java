...
parameter_list|)
operator|,
DECL|enumConstant|ADD_ARTICLE
constructor|ADD_ARTICLE(MaterialDesignIcon.PLUS
block|)
operator|,
...
DECL|enumConstant|Color.rgb
DECL|enumConstant|MaterialDesignIcon.FLAG
name|PRIORITY_LOW
argument_list|(
name|Color
operator|.
...
DECL|enumConstant|Color.rgb
DECL|enumConstant|MaterialDesignIcon.EYE
...
argument_list|)
operator|,
DECL|enumConstant|LIST_MOVE_LEFT
name|LIST_MOVE_LEFT
argument_list|(
name|MaterialDesignIcon
operator|.
...
argument_list|)
operator|,
DECL|enumConstant|LIST_MOVE_UP
name|LIST_MOVE_UP
argument_list|(
name|MaterialDesignIcon
operator|.
...
argument_list|)
operator|,
DECL|enumConstant|LIST_MOVE_RIGHT
name|LIST_MOVE_RIGHT
argument_list|(
name|MaterialDesignIcon
operator|.
name|CHEVRON_RIGHT
argument_list|)
operator|,
DECL|enumConstant|LIST_MOVE_DOWN
name|LIST_MOVE_DOWN
argument_list|(
name|MaterialDesignIcon
operator|.
...
argument_list|)
operator|,
DECL|enumConstant|LATEX_FILE_DIRECTORY
...
argument_list|)
operator|,
DECL|enumConstant|LATEX_COMMENT
name|LATEX_COMMENT
argument_list|(
name|MaterialDesignIcon
operator|.
