...
name|lang
argument_list|(
literal|"Joins selected keywords and deletes selected keywords."
argument_list|)
argument_list|)
expr_stmt|;
name|keywordList
...
name|FormLayout
argument_list|(
literal|"fill:200dlu:grow, pref, fill:pref"
argument_list|,
...
name|this
operator|.
name|addKeywordToKeywordListModel
argument_list|(
name|joinedKeyword
argument_list|)
expr_stmt|;
...
argument_list|)
expr_stmt|;
comment|//enable a user to press Delete to delete a keyword
name|keywordList
operator|.
name|addKeyListener
argument_list|(
...
argument_list|)
expr_stmt|;
comment|//enable a user to press Enter to add a keyword
name|keyword
operator|.
name|addKeyListener
argument_list|(
...
expr_stmt|;
block|}
comment|/**      * Adds given keyword to the keyword list model      */
DECL|method|addKeywordToKeywordListModel (String keyword)
specifier|private
name|void
name|addKeywordToKeywordListModel
parameter_list|(
