...
name|dateFormatter
decl_stmt|;
DECL|method|DateEditorViewModel (Field field, AutoCompleteSuggestionProvider<?> suggestionProvider, DateTimeFormatter dateFormatter, FieldCheckers fieldCheckers)
specifier|public
name|DateEditorViewModel
parameter_list|(
name|Field
