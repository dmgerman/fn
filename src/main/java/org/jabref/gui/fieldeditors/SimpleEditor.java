...
name|viewModel
decl_stmt|;
DECL|method|SimpleEditor (String fieldName, AutoCompleteSuggestionProvider<?> suggestionProvider, FieldCheckers fieldCheckers, JabRefPreferences preferences)
specifier|public
name|SimpleEditor
parameter_list|(
name|String
...
condition|)
block|{
comment|// If content selector values are present, then we want to show the auto complete suggestions immediately on focus
name|autoCompleter
operator|.
name|setShowOnFocus
argument_list|(
