...
block|}
block|}
DECL|method|renameToSuggestion ()
specifier|public
name|void
name|renameToSuggestion
parameter_list|()
block|{
name|renameFileToName
argument_list|(
name|linkedFileHandler
operator|.
...
expr_stmt|;
block|}
DECL|method|askForNameAndRename ()
specifier|public
name|void
...
expr_stmt|;
block|}
DECL|method|renameFileToName (String targetFileName)
specifier|public
name|void
name|renameFileToName
parameter_list|(
...
block|}
block|}
DECL|method|performRenameWithConflictCheck (String targetFileName)
specifier|private
name|void
name|performRenameWithConflictCheck
parameter_list|(
...
block|}
block|}
DECL|method|prepareDownloadTask (Path targetDirectory, URLDownload urlDownload)
specifier|public
name|BackgroundTask
argument_list|<
name|Path
