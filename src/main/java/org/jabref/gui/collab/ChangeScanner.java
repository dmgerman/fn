...
DECL|method|bestFit (List<BibEntry> oldSorter, List<BibEntry> newSorter, int index)
specifier|private
specifier|static
name|BibEntry
name|bestFit
...
block|}
block|}
DECL|method|scanEntries (List<BibEntry> memorySorter, List<BibEntry> tmpSorter, List<BibEntry> diskSorter)
specifier|private
name|void
name|scanEntries
parameter_list|(
