...
expr_stmt|;
block|}
comment|/**      * Sets the values in each preference tab according to Globals.prefs.      * Currently the PreferenceDialogViewModel uses this method, which,      * I believe, is not allowed in the MVVM-model. Fixing this would      * probably require refactoring the JabRefPreferences to use      * Properties probably (?), which would go way beyond this PR.      * So this is just deprecated and awaits refactoring.      */
annotation|@
name|Deprecated
