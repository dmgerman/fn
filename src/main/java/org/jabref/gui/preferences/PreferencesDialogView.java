...
argument_list|)
expr_stmt|;
comment|// ToDo: After conversion of all tabs to mvvm, rework interface and make validSettings bindable
comment|// Button btnSave = (Button) this.getDialogPane().lookupButton(saveButton);
comment|// btnSave.disableProperty().bind(viewModel.validSettings().validProperty().not());
block|}
