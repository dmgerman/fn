...
decl_stmt|;
DECL|method|ColumnPreferences (boolean showFileColumn, boolean showUrlColumn, boolean preferDoiOverUrl, boolean showEprintColumn, List<String> normalColumns, List<SpecialField> specialFieldColumns, List<String> extraFileColumns)
specifier|public
name|ColumnPreferences
parameter_list|(
name|boolean
