...
expr_stmt|;
block|}
DECL|method|MainTable (MainTableDataModel model, JabRefFrame frame, BasePanel panel, BibDatabase database)
specifier|public
name|MainTable
parameter_list|(
name|MainTableDataModel
