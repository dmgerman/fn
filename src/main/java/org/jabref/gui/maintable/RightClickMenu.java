...
name|RightClickMenu
block|{
DECL|method|create (BibEntryTableViewModel entry, KeyBindingRepository keyBindingRepository, BasePanel panel, KeyBindingRepository keyBindings)
specifier|public
specifier|static
name|ContextMenu
name|create
...
return|;
block|}
DECL|method|getAddFileLinkCommand (BasePanel panel)
specifier|private
specifier|static
name|OldCommandWrapper
name|getAddFileLinkCommand
