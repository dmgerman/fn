...
argument_list|)
expr_stmt|;
comment|/*          help.add(this.help);         help.add(openForumAction);         help.addSeparator();         help.add(errorConsole);         help.addSeparator();         help.add(new SearchForUpdateAction());         JMenu webMenu = JabRefFrame.subMenu(Localization.menuTitle("JabRef resources"));         webMenu.add(jabrefWebPageAction);         webMenu.add(jabrefBlogAction);         webMenu.add(jabrefFacebookAction);         webMenu.add(jabrefTwitterAction);         webMenu.addSeparator();         webMenu.add(forkMeOnGitHubAction);         webMenu.add(developmentVersionAction);         webMenu.add(changeLogAction);         webMenu.addSeparator();         webMenu.add(donationAction);         help.add(webMenu);         help.add(about);         */
