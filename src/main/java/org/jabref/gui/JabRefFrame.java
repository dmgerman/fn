...
return|return;
block|}
comment|// We need to get the tab header, the following is a ugly workaround
name|Node
name|tabHeaderArea
init|=
operator|(
...
argument_list|)
expr_stmt|;
comment|// Subscribe to the search
name|EasyBind
operator|.
name|subscribe
argument_list|(
...
argument_list|)
expr_stmt|;
comment|// Update active search query when switching between databases
name|stateManager
operator|.
name|activeSearchQueryProperty
argument_list|()
