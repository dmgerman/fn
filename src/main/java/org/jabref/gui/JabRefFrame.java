...
comment|//   about.actionPerformed(null);
block|}
...
comment|//JPanel toolbarPanel = new JPanel(new WrapLayout(FlowLayout.LEFT));
comment|//toolbarPanel.add(tlb);
...
comment|//tlb.setTransferHandler(xfer);
comment|// TODO: mb.setTransferHandler(xfer);
comment|// TODO: sidePaneManager.getPanel().setTransferHandler(xfer);
block|}
