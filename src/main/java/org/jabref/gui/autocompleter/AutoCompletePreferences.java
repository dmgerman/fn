...
name|journalAbbreviationPreferences
decl_stmt|;
DECL|method|AutoCompletePreferences (boolean shouldAutoComplete, AutoCompleteFirstNameMode firstNameMode, boolean onlyCompleteLastFirst, boolean onlyCompleteFirstLast, Set<Field> completeFields, JournalAbbreviationPreferences journalAbbreviationPreferences)
specifier|public
name|AutoCompletePreferences
parameter_list|(
name|boolean
...
return|;
block|}
DECL|method|setCompleteFields (Set<Field> completeFields)
specifier|public
name|void
