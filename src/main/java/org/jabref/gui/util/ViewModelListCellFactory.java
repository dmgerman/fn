...
return|;
block|}
DECL|method|withStringTooltip (Callback<T, String> toStringTooltip)
specifier|public
name|ViewModelListCellFactory
argument_list|<
name|T
...
return|;
block|}
DECL|method|withTooltip (Callback<T, Tooltip> toTooltip)
specifier|public
name|ViewModelListCellFactory
argument_list|<
name|T
...
return|;
block|}
DECL|method|withPseudoClass (PseudoClass pseudoClass, Callback<T, ObservableValue<Boolean>> toCondition)
specifier|public
name|ViewModelListCellFactory
argument_list|<
name|T
