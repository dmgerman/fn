...
argument_list|)
expr_stmt|;
comment|// Put the pseudo class there depending on the current value
name|changePseudoClass
operator|.
name|accept
argument_list|(
...
expr_stmt|;
block|}
DECL|method|constantOf (T value)
specifier|public
specifier|static
parameter_list|<
name|T
...
return|;
block|}
DECL|method|constantOf (boolean value)
specifier|public
specifier|static
name|ObservableValue
argument_list|<
...
return|;
block|}
DECL|method|ifThenElse (ObservableValue<Boolean> condition, T value, T other)
specifier|public
specifier|static
parameter_list|<
name|T
