...
return|;
block|}
DECL|method|setOnDragDropped (TriConsumer<TableRow<S>, S, ? super DragEvent> toOnDragDropped)
specifier|public
name|ViewModelTableRowFactory
argument_list|<
name|S
...
return|;
block|}
DECL|method|setOnDragExited (TriConsumer<TableRow<S>, S, ? super DragEvent> toOnDragExited)
specifier|public
name|ViewModelTableRowFactory
argument_list|<
name|S
...
return|;
block|}
DECL|method|setOnDragOver (TriConsumer<TableRow<S>, S, ? super DragEvent> toOnDragOver)
specifier|public
name|ViewModelTableRowFactory
argument_list|<
name|S
