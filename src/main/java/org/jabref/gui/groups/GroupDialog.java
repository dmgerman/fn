...
name|setStyle
argument_list|(
literal|"-fx-content-display:top;"
operator|+
literal|"-fx-border-insets:0 0 0 0;"
operator|+
literal|"-fx-border-color:#D3D3D3"
argument_list|)
expr_stmt|;
...
argument_list|)
expr_stmt|;
comment|//TODO: okButton.setDisable(true);
return|return;
block|}
name|String
name|s1
...
expr_stmt|;
block|}
comment|//TODO: okButton.setDisable(!okEnabled);
block|}
