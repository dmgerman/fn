...
expr_stmt|;
block|}
DECL|method|setSelectedGroup (BibDatabaseContext database, GroupTreeNode newSelectedGroup)
specifier|public
name|void
...
return|;
block|}
DECL|method|clearSelectedGroup (BibDatabaseContext database)
specifier|public
name|void
