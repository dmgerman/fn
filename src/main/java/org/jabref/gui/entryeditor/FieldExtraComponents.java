...
return|;
block|}
comment|/**<<<<<<< HEAD =======      * Set up a mouse listener for opening an external viewer and fetching by DOI      *      * @param fieldEditor      * @param panel      * @return      */
...
return|;
block|}
comment|/**>>>>>>> Fix checkstyle warnings      * Return a dropdown list containing Yes and No for fields with EXTRA_YES_NO      *      * @param fieldEditor      * @param entryEditor      * @return      */
