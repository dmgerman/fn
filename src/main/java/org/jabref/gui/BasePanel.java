...
begin_function
DECL|method|editEntryAndFocusField (BibEntry entry, Field field)
specifier|public
name|void
...
begin_comment
comment|/**      * This method is called from an EntryEditor when it should be closed. We relay to the selection listener, which      * takes care of the rest.      */
end_comment

begin_function
DECL|method|entryEditorClosing ()
specifier|public
name|void
...
begin_comment
comment|/**      * Closes the entry editor if it is showing the given entry.      */
end_comment
