...
return|;
block|}
comment|/**      * Returns a {@link EntryFromFileCreator} object that is capable of creating a entry for the given file.      *      * @param file the external file      * @return an empty optional if there is no EntryFromFileCreator for this file.      */
DECL|method|getEntryCreator (Path file)
specifier|public
name|Optional
argument_list|<
name|EntryFromFileCreator
...
DECL|method|addEntrysFromFiles (List<Path> files, BibDatabase database, EntryType entryType, boolean generateKeywordsFromPathToFile)
specifier|public
name|List
argument_list|<
name|String
...
return|;
block|}
comment|/**      * Tries to add a entry for each file in the List.      *      * @return Returns a list of unexpected failures while importing      */
DECL|method|addEntriesFromFiles (List<Path> files, BibDatabase database, BasePanel panel, EntryType entryType, boolean generateKeywordsFromPathToFile)
specifier|public
name|List
argument_list|<
name|String
