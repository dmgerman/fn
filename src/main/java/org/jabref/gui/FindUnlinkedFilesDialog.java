...
decl_stmt|;
DECL|field|labelExportingInfo
specifier|private
name|JLabel
name|labelExportingInfo
decl_stmt|;
DECL|field|tree
specifier|private
name|JTree
...
expr_stmt|;
block|}
comment|/**      * This starts the export of all files of all selected nodes in this      * dialogs tree view.<br>      *<br>      * The export itself will run in a seperate thread, whilst this dialog will      * be showing a progress bar, until the thread has finished its work.<br>      *<br>      * When the export has finished, the {@link #exportFinishedHandler()} is      * invoked.      */
...
expr_stmt|;
block|}
DECL|method|exportFinishedHandler ()
specifier|private
name|void
name|exportFinishedHandler
parameter_list|()
...
name|bSelected
expr_stmt|;
comment|// TODO: Java 9: Generics are stronger?
name|Enumeration
argument_list|<
name|TreeNode
argument_list|>
