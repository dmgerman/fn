...
argument_list|()
expr_stmt|;
comment|//gets this window (stage)
name|long
name|lhwnd
init|=
name|com
...
argument_list|)
decl_stmt|;
comment|//gets the foreground (focused) window
specifier|final
name|User32
name|user32
init|=
...
argument_list|)
expr_stmt|;
comment|//user32.GetWindowText(new HWND(lpVoid), windowText, 512);//to use the hwnd from stage
name|String
name|text
init|=
operator|(
...
operator|)
decl_stmt|;
comment|//see if it's the same pointer
name|ta
operator|.
name|appendText
argument_list|(
...
argument_list|)
expr_stmt|;
comment|//change the window style if it's the right title
if|if
condition|(
name|text
operator|.
...
condition|)
block|{
comment|//the style to change
name|int
name|WS_DLGFRAME
init|=
literal|0x00400000
decl_stmt|;
comment|//s/b long I think
comment|//not the same constant here??
name|ta
operator|.
name|appendText
argument_list|(
...
literal|0x00400000
decl_stmt|;
comment|//bitwise not WS_DLGFRAME means remove the style
name|newStyle
operator|=
name|newStyle
operator|&
