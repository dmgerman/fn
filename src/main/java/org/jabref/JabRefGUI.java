...
decl_stmt|;
DECL|field|WINDOWS_LOOK_AND_FEEL
specifier|private
specifier|static
specifier|final
name|String
name|WINDOWS_LOOK_AND_FEEL
init|=
literal|"com.sun.java.swing.plaf.windows.WindowsLookAndFeel"
decl_stmt|;
DECL|field|OSX_AQUA_LOOk_AND_FEEL
specifier|private
specifier|static
specifier|final
name|String
name|OSX_AQUA_LOOk_AND_FEEL
init|=
...
name|warn
argument_list|(
literal|"Setting Look and Feel to Nimbus"
argument_list|,
name|e
argument_list|)
expr_stmt|;
