...
expr_stmt|;
block|}
DECL|method|BibDatabase (List<BibEntry> entries)
specifier|public
name|BibDatabase
parameter_list|(
name|List
...
expr_stmt|;
block|}
comment|/**      * Replaces the existing lists of BibTexString with the given one      * No Duplicate checks are performed      * @param stringsToAdd The collection of strings to set      */
DECL|method|setStrings (Collection<BibtexString> stringsToAdd)
specifier|public
name|void
name|setStrings
parameter_list|(
