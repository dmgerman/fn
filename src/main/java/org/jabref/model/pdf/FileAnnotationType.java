...
name|name
decl_stmt|;
DECL|field|linkedFileAnnotationType
specifier|private
specifier|final
name|boolean
name|linkedFileAnnotationType
decl_stmt|;
DECL|method|FileAnnotationType (String name, boolean linkedFileAnnotationType)
name|FileAnnotationType
parameter_list|(
name|String
name|name
...
block|}
block|}
comment|/**      * Determines if a String is a supported marked FileAnnotation type.      *      * @param annotationType a type descriptor      * @return true if annotationType is a supported marked FileAnnotation type      */
DECL|method|isMarkedFileAnnotationType (String annotationType)
specifier|public
specifier|static
name|boolean
...
block|}
block|}
DECL|method|isLinkedFileAnnotationType ()
specifier|public
name|boolean
