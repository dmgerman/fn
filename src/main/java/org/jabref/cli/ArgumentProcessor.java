...
return|;
block|}
DECL|method|importBibtexToOpenBase (String argument)
specifier|private
specifier|static
name|Optional
argument_list|<
...
block|}
block|}
DECL|method|saveDatabase (BibDatabase newBase, String subName)
specifier|private
name|void
name|saveDatabase
parameter_list|(
...
block|}
block|}
comment|/**      * Run an entry fetcher from the command line.      *      * @param fetchCommand A string containing both the name of the fetcher to use and      *                     the search query, separated by a :      * @return A parser result containing the entries fetched or null if an error occurred.      */
