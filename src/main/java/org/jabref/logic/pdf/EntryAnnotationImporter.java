...
return|;
block|}
comment|/**      * Reads the annotations from the files that are attached to a BibEntry.      *      * @param context The context is needed for the importer.      * @return Map from each PDF to a list of file annotations      */
DECL|method|importAnnotationsFromFiles (BibDatabaseContext context)
specifier|public
name|Map
argument_list|<
name|String
