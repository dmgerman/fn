...
name|add
argument_list|(
name|createHighlightAnnotations
argument_list|(
name|pageIndex
argument_list|,
name|page
...
return|;
block|}
DECL|method|createHighlightAnnotations (int pageIndex, PDPage page, PDAnnotation annotation)
specifier|private
name|FileAnnotation
name|createHighlightAnnotations
parameter_list|(
...
name|setContents
argument_list|(
literal|"JabRef: Could not extract any highlighted text!"
argument_list|)
expr_stmt|;
block|}
...
return|;
block|}
DECL|method|extractHighlightedText (PDPage page, PDAnnotation annotation)
specifier|private
name|String
name|extractHighlightedText
parameter_list|(
...
return|;
block|}
DECL|method|validatePath (Path path, BibDatabaseContext context)
specifier|private
name|Optional
argument_list|<
name|Path
...
condition|)
block|{
comment|// No need to check file existence again, because it is done in FileUtil.expandFilename()
return|return
name|Optional
operator|.
name|of
