...
decl_stmt|;
DECL|method|DuplicateCheck (BibEntryTypesManager entryTypesManager)
specifier|public
name|DuplicateCheck
parameter_list|(
name|BibEntryTypesManager
...
return|;
block|}
DECL|method|compareRequiredFields (final BibEntryType type, final BibEntry one, final BibEntry two)
specifier|private
specifier|static
name|double
index|[]
...
return|;
block|}
DECL|method|compareOptionalFields (final BibEntryType type, final BibEntry one, final BibEntry two, final double[] req)
specifier|private
specifier|static
name|boolean
...
return|;
block|}
DECL|method|compareFieldSet (final Collection<Field> fields, final BibEntry one, final BibEntry two)
specifier|private
specifier|static
name|double
index|[]
...
return|;
block|}
DECL|method|compareSingleField (final Field field, final BibEntry one, final BibEntry two)
specifier|private
specifier|static
name|int
name|compareSingleField
...
block|{
comment|// We don't know about the type, so simply compare fields without any distinction between optional/required
return|return
name|compareFieldSet
argument_list|(
name|Sets
