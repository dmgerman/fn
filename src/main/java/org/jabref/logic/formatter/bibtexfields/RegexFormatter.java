...
name|replacement
decl_stmt|;
comment|/**      * Constructs a new regular expression-based formatter with the given RegEx.      *      * @param input the regular expressions for matching and replacing given in the form {@code (<regex>,<replace>)}.      */
DECL|method|RegexFormatter (String input)
specifier|public
name|RegexFormatter
parameter_list|(
name|String
...
parameter_list|)
block|{
comment|// formatting is like ("exp1","exp2"), we want to first remove (" and ")
name|String
name|rexToSet
init|=
name|input
