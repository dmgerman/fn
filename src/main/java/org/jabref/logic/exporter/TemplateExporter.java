...
DECL|method|TemplateExporter (String consoleName, String lfFileName, String directory, FileType extension, LayoutFormatterPreferences layoutPreferences, SavePreferences savePreferences, boolean deleteBlankLines)
specifier|public
name|TemplateExporter
parameter_list|(
name|String
