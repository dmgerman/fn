...
expr_stmt|;
block|}
comment|/**      * @param bibentry      */
DECL|method|BracketedPattern (String pattern)
specifier|public
name|BracketedPattern
parameter_list|(
name|String
...
return|;
block|}
DECL|method|expand (BibEntry bibentry)
specifier|public
name|String
name|expand
parameter_list|(
...
expr_stmt|;
block|}
comment|// FIXME: else -> raise exception or log? (S.G.)
block|}
else|else
block|{
if|if
...
condition|)
block|{
comment|// Fetch the next token after the '[':
name|token
operator|=
name|st
operator|.
...
expr_stmt|;
block|}
comment|// Fetch and discard the closing ']'
if|if
condition|(
name|st
operator|.
...
name|warn
argument_list|(
literal|"Missing closing bracket ']' in '"
operator|+
name|pattern
operator|+
literal|"'"
...
name|debug
argument_list|(
literal|"Problem making expanding bracketed expression"
argument_list|,
name|ex
argument_list|)
expr_stmt|;
...
parameter_list|)
block|{
comment|// FIXME: incorrectly exracts the first page when pages are
comment|// specified with ellipse, e.g. "213-6", which should stand
comment|// for "213-216". S.G.
specifier|final
name|String
index|[]
name|splitPages
