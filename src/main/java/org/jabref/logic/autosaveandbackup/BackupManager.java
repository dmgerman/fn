...
literal|".sav"
decl_stmt|;
DECL|field|MINOR_CHANGES_LIMIT
specifier|private
specifier|static
specifier|final
name|int
name|MINOR_CHANGES_LIMIT
init|=
literal|5
decl_stmt|;
...
argument_list|()
decl_stmt|;
DECL|field|minorChangesCount
specifier|private
name|int
name|minorChangesCount
init|=
literal|0
decl_stmt|;
...
block|{
comment|// only do a backup if the field changes are more than one character or if there are enough of them
name|FieldChangedEvent
name|fieldChange
init|=
operator|(
