...
argument_list|()
decl_stmt|;
comment|//databaseWriter.writePartOfDatabase(stringWriter,
comment|//        new BibDatabaseContext(database, new MetaData(), new Defaults()), database.getEntries(),
comment|//        new SavePreferences());
name|String
name|bibtexString
init|=
name|stringWriter
