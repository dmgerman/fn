...
literal|".xml"
decl_stmt|;
DECL|field|MALFORMED_KEY_WORD
specifier|private
specifier|static
specifier|final
name|String
name|MALFORMED_KEY_WORD
init|=
literal|"Malformed"
decl_stmt|;
...
expr_stmt|;
block|}
DECL|method|malformedFileNames ()
specifier|private
specifier|static
name|Stream
argument_list|<
...
name|MethodSource
argument_list|(
literal|"malformedFileNames"
argument_list|)
DECL|method|testImportMalfomedFiles (String fileName)
specifier|public
name|void
name|testImportMalfomedFiles
parameter_list|(
name|String
name|fileName
parameter_list|)
