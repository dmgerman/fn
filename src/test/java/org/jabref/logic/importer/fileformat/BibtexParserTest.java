...
annotation|@
name|Test
DECL|method|integrationTestBibEntryType ()
name|void
name|integrationTestBibEntryType
parameter_list|()
throws|throws
name|IOException
block|{
...
name|StringReader
argument_list|(
literal|"@Comment{jabref-meta: selector_pubstate:approved;captured;received;status;}"
argument_list|)
argument_list|)
decl_stmt|;
name|List
