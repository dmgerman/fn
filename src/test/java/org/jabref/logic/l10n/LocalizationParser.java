...
argument_list|)
expr_stmt|;
comment|// We need to load in "static mode" because otherwise fxml files with fx:root doesn't work
name|setStaticLoad
argument_list|(
name|loader
argument_list|)
...
return|;
block|}
DECL|method|setStaticLoad (FXMLLoader loader)
specifier|private
specifier|static
name|void
name|setStaticLoad
...
parameter_list|)
block|{
comment|// Somebody decided to make "setStaticLoad" package-private, so let's use reflection
try|try
block|{
name|Method
name|method
