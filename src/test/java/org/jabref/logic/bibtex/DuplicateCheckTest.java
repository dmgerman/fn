...
expr_stmt|;
block|}
DECL|method|twoEntriesWithDifferentSpecificFieldsAreNotDuplicates (final BibEntry cloneable, final String fieldType, final String firstValue, final String secondValue)
specifier|private
name|void
name|twoEntriesWithDifferentSpecificFieldsAreNotDuplicates
parameter_list|(
