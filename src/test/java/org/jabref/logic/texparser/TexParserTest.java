...
expr_stmt|;
block|}
DECL|method|addCite (TexParserResult expectedResult, String key, Path texFile, int line, int colStart, int colEnd, String lineText, int resolved)
specifier|private
name|void
name|addCite
parameter_list|(
...
block|}
block|}
DECL|method|testCite (String citeString)
specifier|private
name|void
name|testCite
parameter_list|(
