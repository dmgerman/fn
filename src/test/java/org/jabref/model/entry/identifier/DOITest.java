...
annotation|@
name|Test
DECL|method|acceptPlainShortDoi ()
specifier|public
name|void
name|acceptPlainShortDoi
parameter_list|()
block|{
name|assertEquals
argument_list|(
...
annotation|@
name|Test
DECL|method|ignoreLeadingAndTrailingWhitespacesInShortDoi ()
specifier|public
name|void
name|ignoreLeadingAndTrailingWhitespacesInShortDoi
parameter_list|()
block|{
name|assertEquals
argument_list|(
...
annotation|@
name|Test
DECL|method|rejectEmbeddedShortDoi ()
specifier|public
name|void
name|rejectEmbeddedShortDoi
parameter_list|()
block|{
name|assertThrows
argument_list|(
...
name|DOI
argument_list|(
literal|"other stuff 10/gf4gqc end"
argument_list|)
argument_list|)
expr_stmt|;
block|}
...
annotation|@
name|Test
DECL|method|rejectInvalidDirectoryIndicatorInShortDoi ()
specifier|public
name|void
name|rejectInvalidDirectoryIndicatorInShortDoi
parameter_list|()
block|{
name|assertThrows
argument_list|(
...
annotation|@
name|Test
DECL|method|rejectMissingDividerInShortDoi ()
specifier|public
name|void
name|rejectMissingDividerInShortDoi
parameter_list|()
block|{
name|assertThrows
argument_list|(
...
annotation|@
name|Test
DECL|method|acceptDoiPrefixInShortDoi ()
specifier|public
name|void
name|acceptDoiPrefixInShortDoi
parameter_list|()
block|{
name|assertEquals
argument_list|(
...
annotation|@
name|Test
DECL|method|acceptURNPrefixInShortDoi ()
specifier|public
name|void
name|acceptURNPrefixInShortDoi
parameter_list|()
block|{
name|assertEquals
argument_list|(
...
name|DOI
argument_list|(
literal|"http://doi.org/urn:doi:10/gf4gqc"
argument_list|)
operator|.
name|getDOI
argument_list|()
...
annotation|@
name|Test
DECL|method|acceptURLShortDoi ()
specifier|public
name|void
name|acceptURLShortDoi
parameter_list|()
block|{
comment|// http
name|assertEquals
...
name|DOI
argument_list|(
literal|"http://doi.org/10/gf4gqc"
argument_list|)
operator|.
name|getDOI
argument_list|()
...
name|DOI
argument_list|(
literal|"https://doi.org/10/gf4gqc"
argument_list|)
operator|.
name|getDOI
argument_list|()
...
name|DOI
argument_list|(
literal|"https://dx.doi.org/10%2Fgf4gqc"
argument_list|)
operator|.
name|getDOI
argument_list|()
...
name|DOI
argument_list|(
literal|"http://doi.acm.org/10/gf4gqc"
argument_list|)
operator|.
name|getDOI
argument_list|()
...
name|DOI
argument_list|(
literal|"http://doi.acm.net/10/gf4gqc"
argument_list|)
operator|.
name|getDOI
argument_list|()
...
name|DOI
argument_list|(
literal|"http://doi.acm.com/10/gf4gqc"
argument_list|)
operator|.
name|getDOI
argument_list|()
...
name|DOI
argument_list|(
literal|"http://doi.acm.de/10/gf4gqc"
argument_list|)
operator|.
name|getDOI
argument_list|()
...
name|DOI
argument_list|(
literal|"http://dx.doi.org/10/gf4gqc"
argument_list|)
operator|.
name|getDOI
argument_list|()
...
name|DOI
argument_list|(
literal|"http://dx.doi.net/10/gf4gqc"
argument_list|)
operator|.
name|getDOI
argument_list|()
...
name|DOI
argument_list|(
literal|"http://dx.doi.com/10/gf4gqc"
argument_list|)
operator|.
name|getDOI
argument_list|()
...
name|DOI
argument_list|(
literal|"http://dx.doi.de/10/gf4gqc"
argument_list|)
operator|.
name|getDOI
argument_list|()
...
name|DOI
argument_list|(
literal|"http://doi.ieeecomputersociety.org/10/gf4gqc"
argument_list|)
operator|.
name|getDOI
argument_list|()
...
annotation|@
name|Test
DECL|method|constructCorrectURLForShortDoi ()
specifier|public
name|void
name|constructCorrectURLForShortDoi
parameter_list|()
block|{
name|assertEquals
argument_list|(
...
annotation|@
name|Test
DECL|method|findShortDoiInsideArbitraryText ()
specifier|public
name|void
name|findShortDoiInsideArbitraryText
parameter_list|()
block|{
name|assertEquals
argument_list|(
...
annotation|@
name|Test
DECL|method|parseShortDOIWithWhiteSpace ()
specifier|public
name|void
name|parseShortDOIWithWhiteSpace
parameter_list|()
block|{
name|String
name|shortDoiWithSpace
init|=
literal|"https : / / doi.org / 10 / gf4gqc"
decl_stmt|;
name|assertEquals
...
annotation|@
name|Test
DECL|method|isShortDoiShouldReturnTrueWhenItIsShortDoi ()
specifier|public
name|void
name|isShortDoiShouldReturnTrueWhenItIsShortDoi
parameter_list|()
block|{
name|assertEquals
argument_list|(
...
annotation|@
name|Test
DECL|method|isShortDoiShouldReturnFalseWhenItIsDoi ()
specifier|public
name|void
name|isShortDoiShouldReturnFalseWhenItIsDoi
parameter_list|()
block|{
name|assertEquals
argument_list|(
