...
argument_list|)
expr_stmt|;
comment|// TODO: Add files for rename + relative
name|List
argument_list|<
name|FieldChange
argument_list|>
...
annotation|@
name|Ignore
DECL|method|cleanupRenamePdfDoesSomething ()
specifier|public
name|void
name|cleanupRenamePdfDoesSomething
parameter_list|()
block|{
