...
literal|"copyright"
argument_list|,
literal|"This article is protected by copyright. All rights reserved."
argument_list|)
expr_stmt|;
name|entryWijedasa
operator|.
...
literal|"journal-abbreviation"
argument_list|,
literal|"BMC Complement Altern Med"
argument_list|)
expr_stmt|;
name|entryEndharti
operator|.
...
literal|"copyright"
argument_list|,
literal|"Copyright Â© 2015 Elsevier Ireland Ltd. All rights reserved."
argument_list|)
expr_stmt|;
name|bibEntryIchikawa
operator|.
...
literal|"journal-abbreviation"
argument_list|,
literal|"Southeast Asian J Trop Med Public Health"
argument_list|)
expr_stmt|;
name|bibEntrySari
operator|.
...
name|assertEquals
argument_list|(
literal|"http://eutils.ncbi.nlm.nih.gov/entrez/eutils/efetch.fcgi?db=pubmed&retmode=xml&id="
operator|+
name|fetchID
argument_list|,
name|MedlineFetcher
...
name|searchTerm
init|=
literal|"java,jdk, jabref"
decl_stmt|;
name|assertEquals
argument_list|(
literal|"http://eutils.ncbi.nlm.nih.gov/entrez/eutils/esearch.fcgi?db=pubmed&retmax=1&retstart=0&sort=relevance&term=java+AND+jdk+AND+jabref"
argument_list|,
name|MedlineFetcher
operator|.
