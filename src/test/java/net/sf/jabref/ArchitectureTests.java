...
annotation|@
name|Test
DECL|method|fistPackageIsIndependentOfSecondPackage ()
specifier|public
name|void
name|fistPackageIsIndependentOfSecondPackage
parameter_list|()
throws|throws
name|IOException
block|{
...
argument_list|)
operator|&&
comment|//filter for (sub packages that are allowed to use in the firstPackage
operator|!
operator|(
name|exceptionStrings
operator|.
