...
begin_comment
comment|/**  * This is the test class of the ManageAbbreviationsViewModel which is used to  * create the underlying logic of the Manage Abbreviations Dialog UI.  */
end_comment
...
name|IOException
block|{
comment|// use a new view model for each test so the test methods won't interfere with one another
name|Globals
operator|.
name|prefs
operator|.
...
name|class
argument_list|)
DECL|method|testAddDuplicatedFileResultsInAnException ()
specifier|public
name|void
name|testAddDuplicatedFileResultsInAnException
parameter_list|()
throws|throws
name|DuplicatedJournalFileException
block|{
