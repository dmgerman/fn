...
annotation|@
name|Test
DECL|method|getFieldOrAliasDateWithYearNumericalMonth ()
specifier|public
name|void
name|getFieldOrAliasDateWithYearNumericalMonth
parameter_list|()
block|{
name|BibEntry
name|be
...
name|singleFromString
argument_list|(
literal|"@ARTICLE{HipKro03, year = {2003}, month = mar }"
argument_list|)
decl_stmt|;
name|Assert
operator|.
...
name|singleFromString
argument_list|(
literal|"@ARTICLE{HipKro03, date = {2003}}"
argument_list|)
decl_stmt|;
name|Assert
operator|.
...
name|singleFromString
argument_list|(
literal|"@ARTICLE{HipKro03, date = {2003-03}}"
argument_list|)
decl_stmt|;
name|Assert
operator|.
...
name|singleFromString
argument_list|(
literal|"@ARTICLE{HipKro03, date = {2003-03-30}}"
argument_list|)
decl_stmt|;
name|Assert
operator|.
...
name|class
argument_list|)
DECL|method|putNullKeywordList ()
specifier|public
name|void
name|putNullKeywordList
parameter_list|()
block|{
name|BibEntry
name|be
