...
annotation|@
name|Test
DECL|method|findComplicatedKeys ()
specifier|public
name|void
name|findComplicatedKeys
parameter_list|()
block|{
name|Localization
operator|.
...
annotation|@
name|Test
DECL|method|readWriteTranslationKeys ()
specifier|public
name|void
name|readWriteTranslationKeys
parameter_list|()
throws|throws
name|IOException
block|{
...
name|contains
argument_list|(
literal|"Copy_\\\\cite{BibTeX_key}=Something with \\\\ and \\: \\="
argument_list|)
argument_list|)
expr_stmt|;
block|}
...
name|type
decl_stmt|;
DECL|method|LocalizationEntry (Path path, String key, int lineNumber, LocalizationParser.Type type)
specifier|private
name|LocalizationEntry
parameter_list|(
name|Path
