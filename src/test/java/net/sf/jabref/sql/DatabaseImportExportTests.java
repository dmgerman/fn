...
annotation|@
name|Test
DECL|method|testExportToFileSingleEntry ()
specifier|public
name|void
name|testExportToFileSingleEntry
parameter_list|()
throws|throws
name|Exception
block|{
...
control|)
block|{
name|testExportToFile
argument_list|(
name|databaseContext
argument_list|,
literal|"src/test/resources/net/sf/jabref/sql/database-export-single-entry.sql"
argument_list|,
name|databaseType
argument_list|)
expr_stmt|;
...
annotation|@
name|Test
DECL|method|testExportToFileSingleEntrySingleGroup ()
specifier|public
name|void
name|testExportToFileSingleEntrySingleGroup
parameter_list|()
throws|throws
name|Exception
block|{
...
name|databaseContext
argument_list|,
literal|"src/test/resources/net/sf/jabref/sql/database-export-single-entry-single-group.sql"
argument_list|,
name|databaseType
argument_list|)
expr_stmt|;
block|}
block|}
DECL|method|testExportToFile (BibDatabaseContext databaseContext, String path, DatabaseType databaseType)
specifier|private
name|void
name|testExportToFile
parameter_list|(
