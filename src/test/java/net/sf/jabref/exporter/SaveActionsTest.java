...
literal|"\n"
operator|+
literal|"@comment{jabref-meta: saveActions:enabled;title}"
argument_list|)
argument_list|)
decl_stmt|;
name|ParserResult
...
literal|"\n"
operator|+
literal|"@comment{jabref-meta: saveActions:enabled;title[LowerCaseChanger,]pages[PageNumbersFormatter,]}"
argument_list|)
argument_list|)
decl_stmt|;
name|ParserResult
...
name|assertEquals
argument_list|(
literal|"title[LowerCaseChanger,]pages[PageNumbersFormatter,]"
argument_list|,
name|saveActions
operator|.
name|get
