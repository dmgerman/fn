...
begin_package
DECL|package|tests.net.sf.jabref.util
package|package
name|tests
operator|.
name|net
...
operator|+
literal|"<bibtex:journal>Internation Journal of High Fidelity</bibtex:journal>"
operator|+
...
name|readXMP
argument_list|(
literal|"src/tests/encrypted.pdf"
argument_list|)
expr_stmt|;
name|fail
argument_list|()
