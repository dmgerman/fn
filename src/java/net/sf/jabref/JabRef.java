...
comment|//PlasticLookAndFeel lnf = new com.jgoodies.plaf.plastic.Plastic3DLookAndFeel();
name|Object
name|objLnf
init|=
literal|null
...
try|try
block|{
comment|//lnf2 = Class.forName("com.jgoodies.plaf.plastic.Plastic3DLookAndFeel").newInstance();
if|if
condition|(
name|lookAndFeel
operator|!=
