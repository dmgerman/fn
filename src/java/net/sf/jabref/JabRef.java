...
comment|/*if ((lnf != null)&& (lnf instanceof Plastic3DLookAndFeel)) {                     //MetalLookAndFeel.setCurrentTheme(new                     // com.jgoodies.plaf.plastic.theme.SkyBluer());                     Plastic3DLookAndFeel plLnf = (Plastic3DLookAndFeel) lnf;                     //Plastic3DLookAndFeel.setFontPolicy();                     //Plastic3DLookAndFeel.setFontPolicy(FontPolicy.);                     //plLnf.setFontSizeHints(new FontSizeHints(fontSizes, fontSizes,                     //        fontSizes, fontSizes));                 } else if ((lnf != null)&& (lnf instanceof WindowsLookAndFeel)) {                     //System.out.println("ttt");                     //ExtWindowsLookAndFeel plLnf = (ExtWindowsLookAndFeel) lnf;                     //plLnf.setFontSizeHints(new FontSizeHints(fontSizes, fontSizes,                     //        fontSizes, fontSizes));                 } */
if|if
condition|(
name|lnf
operator|!=
