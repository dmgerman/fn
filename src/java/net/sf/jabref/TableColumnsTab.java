...
comment|// chechbox to (de-)activate PersistenceTableColumnListener
name|JCheckBox
name|listenerCheckbox
init|=
operator|new
name|JCheckBox
argument_list|(
operator|new
name|ActivateMainTableColumnHeaderListenerAction
argument_list|()
argument_list|)
decl_stmt|;
name|builder
...
block|}
block|}
comment|/**      * @author Daniel Waeber      * @author Fabian Bieker      *      */
DECL|class|ActivateMainTableColumnHeaderListenerAction
class|class
name|ActivateMainTableColumnHeaderListenerAction
extends|extends
name|AbstractAction
block|{
comment|// This action gets triggered, when a user wants to use the
comment|// PersistenceTableColumnListener ("Save Database Column Headers"),
comment|// to avoid losing the current state of the gui table column headers.
DECL|field|updateWitdhs
specifier|final
specifier|private
name|UpdateWidthsAction
name|updateWitdhs
decl_stmt|;
DECL|method|ActivateMainTableColumnHeaderListenerAction ()
specifier|public
name|ActivateMainTableColumnHeaderListenerAction
parameter_list|()
block|{
...
name|lang
argument_list|(
literal|"Save Modifications to Database Column Headers"
argument_list|)
argument_list|)
expr_stmt|;
name|updateWitdhs
...
expr_stmt|;
block|}
comment|// add& remove ChangeListener for all databases/mainTables
for|for
control|(
name|int
name|i
