...
DECL|method|performExport (final BibtexDatabase database, final MetaData metaData, Set<String> keySet, Object out)
specifier|private
name|void
name|performExport
parameter_list|(
...
DECL|method|insertJabRefDatabase (final MetaData metaData, Object out)
specifier|private
name|void
...
DECL|method|exportDatabaseToDBMS (final BibtexDatabase database, final MetaData metaData, Set<String> keySet, DBStrings dbStrings)
specifier|public
name|void
...
DECL|method|getDatabaseIDByPath (MetaData metaData, Object out)
specifier|public
name|int
name|getDatabaseIDByPath
parameter_list|(
...
name|out
argument_list|,
literal|"SELECT database_id FROM jabref_database WHERE md5_path=md5('"
operator|+
name|metaData
operator|.
name|getFile
