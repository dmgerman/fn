...
DECL|method|XMPSchemaBibtex (Element e)
specifier|public
name|XMPSchemaBibtex
parameter_list|(
name|Element
...
expr_stmt|;
block|}
comment|/** 	 * Returns a map of all properties and their values. LIs in seqs are 	 * concatenated using " and ". 	 *  	 * @return Map from name of textproperty (String) to value (String). For 	 *         instance: "year" => "2005". Empty map if none found. 	 * @throws TransformerException 	 */
