...
comment|// on the "x" close button. Anyways, I think it is good to have an "exit" button
...
expr_stmt|;
block|}
DECL|method|setEnabled (List l, boolean enabled)
specifier|public
specifier|static
name|void
name|setEnabled
...
argument_list|)
expr_stmt|;
comment|/*if (customImporters.size() == 0) {         submenu.setEnabled(false);         submenu.setToolTipText(Globals.lang("No custom imports registered yet."));       } else {*/
...
expr_stmt|;
block|}
comment|// Add separator if any custom exports have been added:
if|if
condition|(
name|prefs
operator|.
