...
expr_stmt|;
comment|// Groups
comment|/*if (metaData.getGroups() != null) {           panel.groupSelector = new GroupSelector(frame, panel, metaData                   .getGroups(), this, prefs);           register("groups", panel.groupSelector);           if (prefs.getBoolean("groupSelectorVisible"))               ensureVisible("groups");       } else*/
block|{
name|groupSelector
operator|=
operator|new
...
DECL|method|addImportedEntries (BasePanel panel, List entries, String filename, boolean openInNew, ImportInspectionDialog.CallBack callBack)
specifier|public
name|void
