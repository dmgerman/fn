...
name|diag
argument_list|,
literal|"You must choose a style file before you can connect."
argument_list|,
literal|"No style file selected"
argument_list|,
name|JOptionPane
operator|.
name|ERROR_MESSAGE
...
return|;
block|}
DECL|class|TestPanel
class|class
name|TestPanel
extends|extends
name|SidePaneComponent
block|{
DECL|method|TestPanel (SidePaneManager sidePaneManager, URL url, String s)
specifier|public
name|TestPanel
parameter_list|(
name|SidePaneManager
