...
name|PushToApplication
block|{
DECL|field|defaultJStylePath
specifier|public
specifier|static
specifier|final
name|String
name|defaultJStylePath
init|=
literal|"/resource/openoffice/default.jstyle"
decl_stmt|;
...
argument_list|)
expr_stmt|;
comment|/*if (styleFile == null) {                 JOptionPane.showMessageDialog(diag, "You must choose a style file before you can connect.", "No style file selected", JOptionPane.ERROR_MESSAGE);                 return;             }*/
if|if
condition|(
name|style
operator|==
