...
argument_list|)
decl_stmt|,
DECL|field|showDefaultStyle
name|showDefaultStyle
init|=
operator|new
name|JButton
argument_list|(
...
return|;
block|}
comment|/**      * Query whether the radio button for using the default style is selected.      * @return True if the default style is selected.      */
DECL|method|isDefaultSelected ()
specifier|public
name|boolean
...
expr_stmt|;
block|}
DECL|method|displayDefaultStyle ()
specifier|protected
name|void
name|displayDefaultStyle
parameter_list|()
