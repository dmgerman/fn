...
name|FormLayout
argument_list|(
literal|"right:pref, 4dlu, fill:500px, 4dlu, fill:pref"
argument_list|,
...
name|append
argument_list|(
literal|"<p><i>Hint: To search specific fields only, type for example:</i>"
operator|+
literal|"<p><tt>author=miller and title=electrical</tt>"
argument_list|)
expr_stmt|;
return|return
name|sb
