...
block|{
comment|// memorize the selection
name|marked
operator|.
name|appendPosition
argument_list|(
...
try|try
block|{
comment|//        doc.remove( 0, doc.getLength() ) ; // no cut
name|int
name|selStart
init|=
name|textPane
