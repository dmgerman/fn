...
argument_list|)
decl_stmt|;
DECL|field|forOneEntryOnly
name|boolean
name|forOneEntryOnly
init|=
literal|false
decl_stmt|;
...
condition|)
block|{
comment|// Only bes[0] is selected, so we can build specialized menus for it.
name|QuickSearchRule
name|qsr
init|=
operator|new
...
argument_list|)
decl_stmt|;
comment|//groupMenu.add(new JCheckBoxMenuItem(name, (score == 0)));
name|ToggleGroupAction
name|item
init|=
operator|new
name|ToggleGroupAction
...
name|isIn
decl_stmt|;
DECL|method|ToggleGroupAction (String name, String regexp, String field, boolean isIn)
specifier|public
name|ToggleGroupAction
parameter_list|(
name|String
