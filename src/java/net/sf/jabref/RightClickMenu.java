...
name|m_group
decl_stmt|;
DECL|method|AddToGroupAction (AbstractGroup group)
specifier|public
name|AddToGroupAction
parameter_list|(
name|AbstractGroup
...
argument_list|)
expr_stmt|;
comment|// JZTODO: mark change& add undo
block|}
block|}
...
name|m_group
decl_stmt|;
DECL|method|RemoveFromGroupAction (AbstractGroup group)
specifier|public
name|RemoveFromGroupAction
parameter_list|(
name|AbstractGroup
...
name|m_isIn
decl_stmt|;
DECL|method|ToggleGroupAction (AbstractGroup group, boolean isIn)
specifier|public
name|ToggleGroupAction
parameter_list|(
name|AbstractGroup
