...
return|;
block|}
comment|/*public void paintComponent(Graphics g) { 		Graphics2D g2 = (Graphics2D) g; 		Object hint = g2.getRenderingHint(RenderingHints.KEY_ANTIALIASING); 		g2.setRenderingHint(RenderingHints.KEY_ANTIALIASING, RenderingHints.VALUE_ANTIALIAS_ON); 		g2.setRenderingHint(RenderingHints.KEY_RENDERING, RenderingHints.VALUE_RENDER_QUALITY); 		super.paintComponent(g2); 		g2.setRenderingHint(RenderingHints.KEY_ANTIALIASING, hint); 	}*/
...
name|PropertyVetoException
block|{
comment|/*if (entry != null)             System.out.println("Updating: "+entry.getCiteKey());*/
name|update
argument_list|()
expr_stmt|;
block|}
