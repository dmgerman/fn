...
return|;
block|}
DECL|method|displayTable (BasePanel panel, BibtexDatabase database, Comparator comp)
specifier|public
specifier|static
name|void
name|displayTable
...
argument_list|)
expr_stmt|;
comment|/*java.util.List selected = table.getSelected();                 for (Iterator i=selected.iterator(); i.hasNext();) {                     System.out.println(i.next());                 }*/
block|}
block|}
argument_list|)
expr_stmt|;
