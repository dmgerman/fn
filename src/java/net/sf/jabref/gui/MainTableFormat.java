...
block|}
comment|// No need to check for == null, since it's been done in hasField(...) already
name|o
operator|=
name|GUIGlobals
operator|.
...
condition|)
block|{
comment|// Check ranking level
name|int
name|entryRankingValue
init|=
literal|1
decl_stmt|;
try|try
