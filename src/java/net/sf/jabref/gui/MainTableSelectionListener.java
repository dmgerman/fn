...
block|}
block|}
comment|/**      * We should implement a faster method than the one below, but this one doesn't      * work currently.      * @param e The KeyEvent      */
DECL|method|keyTyped_ (KeyEvent e)
specifier|public
name|void
name|keyTyped_
parameter_list|(
...
condition|)
return|return;
comment|// Ok, after all of this we should have either found a field name to go by
name|String
name|field
init|=
operator|(
