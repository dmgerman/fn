...
argument_list|)
decl_stmt|;
comment|//private MyTableModel tableModel = new MyTableModel();
comment|//private JTable table = new MyTable(tableModel);
DECL|field|glTable
specifier|private
name|JTable
name|glTable
...
argument_list|)
expr_stmt|;
comment|//contentPane.setTopComponent(new JScrollPane(table));
name|contentPane
operator|.
