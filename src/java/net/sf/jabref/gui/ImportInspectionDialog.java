...
block|}
block|}
comment|/*public void removeKeys() {         for (Iterator i = entries.iterator(); i.hasNext();) {             BibtexEntry entry = (BibtexEntry) i.next();             entry.setField(Globals.KEY_FIELD, null);         }         tableModel. // AAAAAAAAAAHHH no removeColumn()?????????     } */
...
control|)
block|{
comment|// Only check entries that are to be imported:
name|Boolean
name|sel
init|=
operator|(
...
condition|)
block|{
comment|// This should be true since the icon is displayed...
