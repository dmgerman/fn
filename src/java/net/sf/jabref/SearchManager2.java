...
argument_list|)
expr_stmt|;
comment|/*         if (reorder.isSelected()) { 		// Float search. 		DatabaseSearch search = new DatabaseSearch 		    (this, searchOptions,searchRules, panel, 		     Globals.SEARCH, true, true//Globals.Globals.prefs.getBoolean("grayOutNonHits")                     , select.isSelected()); 		search.start() ; 	    } 	    else if (normal.isSelected()) { 		// Highlight search. 		DatabaseSearch search = new DatabaseSearch 		    (this, searchOptions,searchRules, panel, 		     Globals.SEARCH, false, true, select.isSelected()); 		search.start() ; 	    }         */
