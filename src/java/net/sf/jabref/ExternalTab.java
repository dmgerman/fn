...
name|_frame
decl_stmt|;
comment|//private JComboBox language = new JComboBox(GUIGlobals.LANGUAGES.keySet().toArray());
DECL|field|pdfDir
DECL|field|psDir
DECL|field|pdf
DECL|field|ps
...
name|citeCommand
decl_stmt|;
comment|//private HelpAction ownerHelp, pdfHelp;
...
argument_list|)
expr_stmt|;
comment|//pdfHelp = new HelpAction(frame.helpDiag, GUIGlobals.pdfHelp,
comment|//        "Help", GUIGlobals.helpSmallIconFile);
name|psDir
operator|=
operator|new
name|JTextField
