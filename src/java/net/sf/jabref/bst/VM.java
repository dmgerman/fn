...
return|;
block|}
DECL|method|run (Collection bibtex)
specifier|public
name|String
name|run
parameter_list|(
...
name|entry
decl_stmt|;
comment|// Map<String, String> strings = new HashMap<String, String>();
comment|// Map<String, String> fields = new HashMap<String, String>();
comment|// Map<String, Integer> integers = new HashMap<String, Integer>();
DECL|field|strings
name|Map
name|strings
init|=
...
argument_list|()
decl_stmt|;
comment|// Map<String, BstFunction> functions = new HashMap<String, BstFunction>();
...
argument_list|()
decl_stmt|;
comment|// Stack<Object> stack = new Stack<Object>();
DECL|field|stack
name|Stack
name|stack
init|=
