...
return|;
block|}
DECL|method|exportCustomDatabase (BibtexDatabase database, String directory, String lfName, File outFile, String encoding)
specifier|public
specifier|static
name|void
...
expr_stmt|;
block|}
DECL|method|exportDatabase (BibtexDatabase database, String lfName, File outFile, String encoding)
specifier|public
specifier|static
name|void
name|exportDatabase
...
expr_stmt|;
block|}
DECL|method|exportDatabase (BibtexDatabase database, String prefix, String lfName, File outFile, String encoding)
specifier|public
specifier|static
name|void
name|exportDatabase
...
argument_list|()
decl_stmt|;
comment|//ps = new OutputStreamWriter(new FileOutputStream(outFile), encoding);
name|exportDatabase
argument_list|(
name|database
argument_list|,
...
expr_stmt|;
block|}
DECL|method|performExport (final BibtexDatabase database, final String exportName, final String fileName, final String encoding)
specifier|public
specifier|static
name|void
name|performExport
...
name|outFile
decl_stmt|;
comment|//System.out.println(oFile.getPath()+"\t "+dir+"\t "+lfName+"\t "+encoding);
name|FileActions
operator|.
name|exportDatabase
argument_list|(
