...
name|terD
decl_stmt|;
DECL|method|SaveSettings (boolean isSaveOperation)
specifier|public
name|SaveSettings
parameter_list|(
name|boolean
...
case|:
default|default:
comment|// The setting is to save according to the specified order.
name|pri
operator|=
name|Globals
operator|.
...
block|}
block|}
DECL|method|getSaveComparators (boolean isSaveOperation)
specifier|private
specifier|static
name|List
argument_list|<
