...
return|;
block|}
comment|/**       * Will look through a String and highlights every presence of a searched word      *       * @param content This is a String in which we search for a word      * @param word This String will get highlighted if it is found - this is interpreted as regular expression!      *       * @return The text which was called by the method with HTML Tags to highlight the word that was searched      */
DECL|method|highlightWord (String content, String word)
specifier|private
name|String
name|highlightWord
parameter_list|(
...
condition|)
block|{
comment|// TODO: convert tohighlight to regex (word1) | (word2) | (word3) and call highlightWord only once
for|for
control|(
name|String
name|word
