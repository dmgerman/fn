...
expr_stmt|;
block|}
comment|/*if (key.equals("order")) {             value = value.toLowerCase();             if (value.equals("ff") || value.equals("firstfirst"))                 flMode = FIRST_FIRST;             else if (value.equals("lf") || value.equals("lastfirst"))                 flMode = LAST_FIRST;             else if (value.equals("lf-ff") || value.equals("lastfirst-firstfirst"))                 flMode = LF_FF;         }         else if (key.equals("separator")) {                      }*/
block|}
...
name|setArgument
argument_list|(
literal|"LastFirstFirst,Initials,NoComma,Comma,LastSep= und ,2,EtAl= m.fl."
argument_list|)
expr_stmt|;
name|System
operator|.
...
name|format
argument_list|(
literal|"Jo-Arve Alfredsen and Morten O. Alver and Yngvar von Olsen and S. A. L. M. Kooijman"
argument_list|)
argument_list|)
expr_stmt|;
block|}
