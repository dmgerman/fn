...
argument_list|()
expr_stmt|;
comment|//Collection c = bibtex.getEntries();
comment|/*for(Iterator iter = c.iterator(); iter.hasNext(); ) {                         BibtexEntry entry = (BibtexEntry) iter.next();                         MODSEntry newMods = new MODSEntry(entry);                         entries.add(newMods);                 }*/
block|}
