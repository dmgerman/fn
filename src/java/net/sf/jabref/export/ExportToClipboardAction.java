...
expr_stmt|;
block|}
comment|//ExportFormat[] formats = (ExportFormat[])(m.entrySet().toArray
comment|//        (new ExportFormat[m.size()]));
comment|// Make a list of possible formats:
comment|/*Map formats = new HashMap();         formats.put("BibTeXML", "bibtexml");         formats.put("DocBook", "docbook");         formats.put("HTML", "html");         formats.put("RTF (Harvard)", "harvard/harvard");         formats.put("Simple HTML", "simplehtml");         for (int i = 0; i< Globals.prefs.customExports.size(); i++) {             Object o = (Globals.prefs.customExports.getElementAt(i))[0];             formats.put(o, o);         }*/
name|String
index|[]
name|array
init|=
