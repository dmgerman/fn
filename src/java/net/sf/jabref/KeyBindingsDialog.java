...
parameter_list|()
block|{
comment|//list.setSelectionMode(ListSelectionModel.SINGLE_SELECTION);
comment|//list.getModel().addListDataListener(new MyListDataListener());
comment|// This method is called each time the user changes the set of selected items
comment|//list.addListSelectionListener(new MyListSelectionListener());
name|DefaultListModel
name|listModel
init|=
operator|new
...
name|data
decl_stmt|;
DECL|method|KeystrokeTableModel (String[][] tableData)
specifier|public
name|KeystrokeTableModel
parameter_list|(
name|String
