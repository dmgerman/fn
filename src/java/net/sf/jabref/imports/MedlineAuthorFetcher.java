...
begin_class
DECL|class|MedlineAuthorFetcher
specifier|public
class|class
...
DECL|method|MedlineAuthorFetcher (BasePanel panel_, SidePaneManager p0)
specifier|public
name|MedlineAuthorFetcher
parameter_list|(
name|BasePanel
...
index|]
decl_stmt|;
comment|// prepare an array of titles for the dialog
name|titles
operator|=
name|getTitles
argument_list|(
...
operator|+
literal|"?db=pubmed&retmode=xml&rettype=citation&id="
operator|+
name|id
decl_stmt|;
name|URL
...
DECL|method|getCitations (String[] ids)
specifier|public
name|String
index|[]
name|getCitations
