...
return|;
block|}
DECL|method|CiteSeerUndoHandler (NamedCompound newCompound, BibtexEntry be, BasePanel basePanel, BooleanAssign assignment, BooleanAssign overwriteAll, BooleanAssign overwriteNone)
specifier|public
name|CiteSeerUndoHandler
parameter_list|(
name|NamedCompound
