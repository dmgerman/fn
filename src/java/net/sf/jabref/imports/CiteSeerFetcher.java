...
decl_stmt|;
DECL|method|ShowBadIdentifiersDialog (Hashtable<Integer, BibtexEntry> entries)
name|ShowBadIdentifiersDialog
parameter_list|(
name|Hashtable
argument_list|<
...
return|;
block|}
DECL|method|generateCitationList (Map<String, Boolean> citationHashTable, BibtexDatabase database)
specifier|private
name|Map
argument_list|<
name|String
...
return|;
block|}
DECL|method|generateIdentifierList (BibtexEntry currentEntry, Map<String, Boolean> citationHashTable, Hashtable<Integer, BibtexEntry> rejectedEntries)
specifier|private
name|boolean
name|generateIdentifierList
parameter_list|(
...
DECL|method|importCiteSeerEntry (BibtexEntry be, NamedCompound citeseerNC, BooleanAssign overwriteAll, BooleanAssign overwriteNone, BooleanAssign newValue, Hashtable<Integer, BibtexEntry> rejectedEntries)
specifier|public
name|boolean
name|importCiteSeerEntry
parameter_list|(
