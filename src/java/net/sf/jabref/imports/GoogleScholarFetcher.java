...
name|compile
argument_list|(
literal|"<div class=gs_r><h3 class=\"gs_rt\"><a href=\"([^\"]*)\">"
argument_list|)
decl_stmt|;
...
name|compile
argument_list|(
literal|"<a href=\"([^\"]*)\"><span class=\"SPRITE_nav_next\"></span><br><span style=\".*\">Next</span></a>"
argument_list|)
decl_stmt|;
...
name|lang
argument_list|(
literal|"%0 entries were found, but only %1 of these could be resolved."
argument_list|,
name|String
operator|.
name|valueOf
...
name|lang
argument_list|(
literal|"Incomplete search results"
argument_list|)
argument_list|,
name|JOptionPane
operator|.
