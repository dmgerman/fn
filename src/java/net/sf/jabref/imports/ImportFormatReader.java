...
argument_list|)
expr_stmt|;
comment|// Regarding authors, it appears Sixpack saves with first name first, and normal grammar.
name|entry
operator|.
name|setField
argument_list|(
...
argument_list|)
expr_stmt|;
comment|//         Util.pr(fields[1] + "   (" + fields.length + ")");
block|}
catch|catch
parameter_list|(
...
name|logger
argument_list|(
literal|"Error parsing Sixpack file, ignoring entry."
argument_list|)
expr_stmt|;
block|}
block|}
...
comment|//  Util.pr(":"+s[i]);
comment|/*Util.pr(in.readLine());               Util.pr(in.readLine());               Util.pr(in.readLine());                int str, i=0;               while ((i< 100)&& (str = in.read())>= 0) {                       Util.pr(""+(char)str+"  "+str);                       i++;               }*/
name|in
operator|.
name|close
argument_list|()
