...
DECL|method|purgeEmptyEntries (ArrayList entries)
specifier|public
specifier|static
name|void
name|purgeEmptyEntries
...
block|}
block|}
comment|/**      * Tries to import a file by iterating through the available import filters,      * and keeping the import that seems most promising. Returns an Object array      * with two elements, 0: the name of the format used, 1: the database.      */
...
control|)
block|{
comment|//System.out.println("Trying format: "+formats[i]);
try|try
block|{
name|BibtexDatabase
name|base
...
operator|)
decl_stmt|;
comment|//System.out.println("Entries: "+entries);
if|if
condition|(
name|entries
operator|>
