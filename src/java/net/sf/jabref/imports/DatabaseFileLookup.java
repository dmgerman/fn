...
block|{
comment|// bibtexfilepath is relative path
comment|// so try to get full path from possibleFilePaths
name|exists
operator|=
literal|false
expr_stmt|;
...
control|)
block|{
comment|//System.out.println("trying: " + s+File.separatorChar+link);
name|asFile
operator|=
operator|new
name|File
...
condition|)
block|{
comment|// leave loop if file exists
name|exists
operator|=
literal|true
expr_stmt|;
...
block|}
block|}
comment|// file was found creating some possible absolute path for it
if|if
condition|(
name|exists
operator|&&
