...
DECL|method|searchDirectory (File directory, FileFilter aFileFilter, int[] state, ChangeListener changeListener)
specifier|public
name|CheckableTreeNode
name|searchDirectory
parameter_list|(
