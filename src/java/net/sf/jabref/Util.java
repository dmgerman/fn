...
DECL|method|checkForDOI (String check)
specifier|public
specifier|static
name|boolean
name|checkForDOI
...
literal|false
decl_stmt|;
comment|// Check http://... .doi. ... .<end> first
comment|// .ORG
if|if
condition|(
name|check
...
expr_stmt|;
block|}
comment|// Check http://doi. ... .<end> now
comment|// .ORG
if|if
condition|(
name|check
...
return|;
block|}
comment|/**    	 * Remove the http://... from DOI    	 * @param doi    	 * @return    	 */
DECL|method|parseDOI (String doi)
specifier|public
specifier|static
name|String
name|parseDOI
