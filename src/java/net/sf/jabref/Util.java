...
condition|)
block|{
comment|//System.out.println(expandFilename(link, prefs.get(fieldName+"Directory")));
name|File
name|file
init|=
name|expandFilename
...
argument_list|)
expr_stmt|;
comment|/*cmdArray[0] = prefs.get("htmlviewer");                     cmdArray[1] = link;                     Process child = Runtime.getRuntime().exec(                     cmdArray[0] + " " + cmdArray[1]);                     */
block|}
else|else
block|{
name|cmdArray
...
argument_list|)
expr_stmt|;
comment|/*                     cmdArray[0] = prefs.get("psviewer");                     cmdArray[1] = link;                     Process child = Runtime.getRuntime().exec(                             cmdArray[0] + " " + cmdArray[1]);                     */
block|}
else|else
block|{
name|cmdArray
...
expr_stmt|;
block|}
DECL|method|unmarkEntry (BibtexEntry be, NamedCompound ce)
specifier|public
specifier|static
name|void
name|unmarkEntry
