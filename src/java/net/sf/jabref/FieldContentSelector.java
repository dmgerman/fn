...
DECL|method|FieldContentSelector (JabRefFrame jabRefFrame, final BasePanel panel, Window ownerFrameOrDialog, final FieldEditor editor, final MetaData metaData, final AbstractAction action, boolean horizontalLayout, String delimiter)
specifier|public
name|FieldContentSelector
parameter_list|(
name|JabRefFrame
...
parameter_list|)
block|{
comment|// I don't get the difference here:
