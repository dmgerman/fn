...
condition|)
block|{
comment|// TODO: the following line (possibly) prevents ArrayIndexOutOfBoundsException
comment|// from the EventList providing data for the main table. This shouldn't be the
comment|// case...
try|try
block|{
name|Thread
