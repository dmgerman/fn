...
argument_list|()
expr_stmt|;
comment|/*drd = new DuplicateResolverDialog(panel.frame, be[0], be[1],                     askAboutExact ? DuplicateResolverDialog.DUPLICATE_SEARCH_WITH_EXACT :                             DuplicateResolverDialog.DUPLICATE_SEARCH);             drd.setVisible(true);*/
name|duplicateCounter
operator|++
expr_stmt|;
comment|//int answer = drd.getSelected();
name|int
name|answer
init|=
name|cb
