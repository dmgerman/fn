...
argument_list|()
decl_stmt|;
comment|// Contains table icon mappings for ranking icons. Set up
DECL|field|prioTableIcons
specifier|static
name|HashMap
argument_list|<
name|String
...
argument_list|()
decl_stmt|;
comment|// Contains table icon mappings for priority icons. Set up
...
return|;
block|}
comment|/** 	 * Returns rankingIcons depending und rankingLevel 	 * @param rankingLevel Level of Ranking 	 * @return rankingIcon 	 */
DECL|method|getTableRankingIcon (int rankingLevel)
specifier|public
specifier|static
name|JLabel
name|getTableRankingIcon
parameter_list|(
name|int
name|rankingLevel
parameter_list|)
...
return|;
block|}
comment|/** 	 * Returns priorityIcons depending und priorityLevel 	 * @param priorityLevel Level of Priority 	 * @return priorityIcon 	 */
DECL|method|getTablePriorityIcon (int rankingLevel)
specifier|public
specifier|static
name|JLabel
name|getTablePriorityIcon
parameter_list|(
name|int
name|rankingLevel
parameter_list|)
...
return|;
block|}
DECL|method|getIconString (int priorityLevel)
specifier|public
specifier|static
name|String
name|getIconString
...
return|;
block|}
DECL|method|getPrioString (int priorityLevel)
specifier|public
specifier|static
name|String
name|getPrioString
...
argument_list|)
expr_stmt|;
comment|// Create a ranking dummy Icon
name|lab
operator|=
operator|new
name|JLabel
...
argument_list|)
expr_stmt|;
comment|// Ranking icons in own List
for|for
control|(
name|int
name|i
...
expr_stmt|;
block|}
comment|// Create a priority dummy Icon
name|lab
operator|=
operator|new
name|JLabel
...
argument_list|)
expr_stmt|;
comment|// Priority Icons in own List
name|lab
operator|=
operator|new
name|JLabel
