...
argument_list|)
expr_stmt|;
comment|// Read the image resource bundle, and put all the information into a more
comment|// practical HashMap. We may drop the resourcebundle altogether, eventually.
name|iconBundle
operator|=
name|ResourceBundle
operator|.
