...
argument_list|)
decl_stmt|;
comment|/*newSmallIconFile = GUIGlobals.class.getResource(pre+"New16.gif"), 	addIconFile = GUIGlobals.class.getResource(pre+"Add"+ex), 	removeIconFile = GUIGlobals.class.getResource(pre+"Remove"+ex), 	copyIconFile = GUIGlobals.class.getResource(pre+"Copy"+ex), 	pasteIconFile = GUIGlobals.class.getResource(pre+"Paste"+ex), 	editEntryIconFile = GUIGlobals.class.getResource(pre+"Edit"+ex), 	searchIconFile = GUIGlobals.class.getResource(pre+"Find"+ex), 	helpIconFile = GUIGlobals.class.getResource(pre+"Help"+ex), 	helpSmallIconFile = GUIGlobals.class.getResource(pre+"Help16.gif"), //	closeIconFile = GUIGlobals.class.getResource(pre+"closeIcon.jpg"), 	closeIconFile = GUIGlobals.class.getResource(pre+"close16.gif"), //	copyKeyIconFile = GUIGlobals.class.getResource(pre+"copyKeyIcon.jpg"), 	copyKeyIconFile = GUIGlobals.class.getResource(pre+"copyKey2.gif"), 	showReqIconFile = GUIGlobals.class.getResource(pre+"r_icon.gif"), 	showOptIconFile = GUIGlobals.class.getResource(pre+"o_icon.gif"), 	showGenIconFile = GUIGlobals.class.getResource(pre+"g_icon.gif"), 	genKeyIconFile = GUIGlobals.class.getResource(pre+"genKey.gif"), 	preambleIconFile = GUIGlobals.class.getResource(pre+"preamble.gif"), 	upIconFile = GUIGlobals.class.getResource(pre+"Up"+ex), 	downIconFile = GUIGlobals.class.getResource(pre+"Down"+ex), 	backIconFile = GUIGlobals.class.getResource(pre+"Back"+ex), 	forwardIconFile = GUIGlobals.class.getResource(pre+"Forward"+ex), 	sourceIconFile = GUIGlobals.class.getResource(pre+"viewsource.gif"), 	stringsIconFile = GUIGlobals.class.getResource(pre+"strings.gif"), 	contentsIconFile = GUIGlobals.class.getResource(pre+"contents.gif"), 	groupsIconFile = GUIGlobals.class.getResource(pre+"groups.gif"), 	refreshSmallIconFile = GUIGlobals.class.getResource(pre+"Refresh16.gif"); 	*/
