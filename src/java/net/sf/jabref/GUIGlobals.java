...
argument_list|)
decl_stmt|;
comment|/*newSmallIconFile = GUIGlobals.class.getResource(pre+"New16.gif"), 	pasteIconFile = GUIGlobals.class.getResource(pre+"Paste"+ex), 	editEntryIconFile = GUIGlobals.class.getResource(pre+"Edit"+ex), 	searchIconFile = GUIGlobals.class.getResource(pre+"Find"+ex), 	helpSmallIconFile = GUIGlobals.class.getResource(pre+"Help16.gif"), 	closeIconFile = GUIGlobals.class.getResource(pre+"close16.gif"), 	stringsIconFile = GUIGlobals.class.getResource(pre+"strings.gif"), 	groupsIconFile = GUIGlobals.class.getResource(pre+"groups.gif"), 	refreshSmallIconFile = GUIGlobals.class.getResource(pre+"Refresh16.gif"); 	*/
