...
condition|)
block|{
comment|//SwingUtilities.invokeLater(t);
name|panel
operator|.
name|hideEntryEditor
argument_list|()
...
expr_stmt|;
block|}
comment|//Util.pr(".."+tabbed.getSelectedComponent().toString());
comment|//Util.pr("Sourceaccepted: "+lastSourceAccepted);
return|return
name|lastSourceAccepted
return|;
block|}
