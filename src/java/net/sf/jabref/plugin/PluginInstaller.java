...
name|lang
argument_list|(
literal|"Deletion of old versions failed."
argument_list|)
argument_list|,
name|Globals
operator|.
...
operator|+
literal|"version from filename."
operator|+
literal|" File name convention is '[plugin name]-[version].jar'."
argument_list|)
operator|+
literal|"<br>"
operator|+
...
return|;
block|}
DECL|method|deleteOlderVersions (String filename)
specifier|public
specifier|static
name|boolean
name|deleteOlderVersions
...
block|}
return|;
comment|// unknown version is set to 0
block|}
else|else
return|return
literal|null
...
literal|0
decl_stmt|;
DECL|method|NameAndVersion (String name, VersionNumber version)
specifier|public
name|NameAndVersion
parameter_list|(
name|String
