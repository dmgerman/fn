...
block|}
DECL|method|BasePanel (JabRefFrame frame, BibtexDatabase db, File file, HashMap<String, String> meta, String encoding)
specifier|public
name|BasePanel
parameter_list|(
name|JabRefFrame
...
literal|null
argument_list|,
literal|"You need to save your database in the disk \n"
operator|+
literal|"before saving. Save it now?"
argument_list|,
literal|"Database is not saved"
argument_list|,
name|JOptionPane
operator|.
name|YES_NO_OPTION
...
name|errorMessage
operator|=
literal|"Database was not exported. Your database must be saved \nbefore exporting to a SQL database"
expr_stmt|;
block|}
catch|catch
parameter_list|(
...
name|lang
argument_list|(
literal|"Set entries to relevant"
argument_list|)
argument_list|)
decl_stmt|;
name|BibtexEntry
...
name|lang
argument_list|(
literal|"Set entries to irelevant"
argument_list|)
argument_list|)
decl_stmt|;
name|BibtexEntry
...
name|lang
argument_list|(
literal|"Set entries quality to good"
argument_list|)
argument_list|)
decl_stmt|;
name|BibtexEntry
...
name|lang
argument_list|(
literal|"Set entries quality to bad"
argument_list|)
argument_list|)
decl_stmt|;
name|BibtexEntry
...
argument_list|)
expr_stmt|;
comment|//Add the new entry to the group(s) selected in the Group Panel
name|addToSelectedGroup
argument_list|(
name|be
argument_list|)
...
return|;
block|}
comment|/**      * This method is called to add a new entry to a group (or a set of groups)      * in case the Group View is selected and one or more groups are marked      * @param bibEntry The new entry.      */
DECL|method|addToSelectedGroup (final BibtexEntry bibEntry)
specifier|private
name|void
name|addToSelectedGroup
parameter_list|(
...
DECL|method|parseMetaData (HashMap<String, String> meta)
specifier|public
name|void
name|parseMetaData
parameter_list|(
