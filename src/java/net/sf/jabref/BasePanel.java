...
name|lang
argument_list|(
literal|"First select the entries that you want to do a cleanup for."
argument_list|)
argument_list|,
name|Globals
operator|.
...
argument_list|)
decl_stmt|;
comment|// Remove the http://... for each DOI
for|for
control|(
name|Iterator
argument_list|<
...
argument_list|)
expr_stmt|;
comment|// The action for auto-generating PDF-Names.
name|actions
operator|.
name|put
argument_list|(
...
condition|)
block|{
comment|// Empty selection. Inform the user to select entries first.
name|JOptionPane
operator|.
name|showMessageDialog
argument_list|(
...
name|lang
argument_list|(
literal|"First select the entries you want Auto-PDF-Names to be generated for."
argument_list|)
argument_list|,
name|Globals
operator|.
...
name|lang
argument_list|(
literal|"Generating Auto-PDF-Names for"
argument_list|)
operator|+
literal|" "
operator|+
...
literal|null
decl_stmt|;
comment|// Ask if undoable action should be continued
if|if
condition|(
name|Globals
operator|.
...
condition|)
block|{
comment|//if the entry is not linked with a pdf
continue|continue;
block|}
name|String
...
operator|++
expr_stmt|;
comment|//Count this not succesfull rename
block|}
block|}
if|if
condition|(
...
name|lang
argument_list|(
literal|"Generated Auto-PDF-Names for"
argument_list|)
operator|+
literal|" "
operator|+
