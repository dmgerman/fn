...
block|}
block|}
comment|// Done with autosetting keys. Now save the database:
name|success
operator|=
name|saveDatabase
argument_list|(
...
name|println
argument_list|(
literal|"actual export to clipboard not implemented..."
argument_list|)
expr_stmt|;
comment|//FileActions.exportEntries(database, bes, format, custom, directory, sw);
name|ClipboardOwner
name|owner
init|=
operator|new
