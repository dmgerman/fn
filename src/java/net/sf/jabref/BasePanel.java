...
literal|false
decl_stmt|;
comment|//SidePaneManager sidePaneManager;
...
argument_list|)
expr_stmt|;
comment|//mainPanel.removeAll();
comment|//mainPanel.setLayout(new GridLayout(1,1));
...
argument_list|)
expr_stmt|;
comment|/*sidePaneManager = new SidePaneManager 	    (prefs, metaData, this, mainPanel); 	    sidePaneManager.populatePanel();*/
