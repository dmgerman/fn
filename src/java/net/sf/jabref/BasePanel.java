...
argument_list|)
expr_stmt|;
comment|/*output(                                   Globals.lang("Pushed the citations for the following rows to")+"WinEdt: " +                                   message);*/
block|}
block|}
catch|catch
parameter_list|(
...
decl_stmt|;
comment|//int answer = JOptionPane.showConfirmDialog(frame, warning, Globals.lang("Save database"),
