...
block|{
comment|// As the DOI field is empty we now check if Notes or URL contains a DOI
if|if
condition|(
name|bes
operator|.
...
argument_list|)
expr_stmt|;
comment|// Clear Note and URL if DOI has been changed and Preferences has been set
if|if
condition|(
name|Globals
operator|.
