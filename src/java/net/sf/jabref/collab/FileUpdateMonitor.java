...
parameter_list|()
block|{
comment|/*       Util.pr("<copy file=\""+tmpFile.getPath()+"\">");       boolean res = false;       try {         res = Util.copyFile(file, tmpFile, true);       } catch (IOException ex) {         Globals.logger("Cannot copy to temporary file '"+tmpFile.getPath()+"'");       }       Util.pr("</copy>");       return res; 	*/
return|return
literal|true
return|;
block|}
