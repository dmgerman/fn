...
return|;
block|}
DECL|method|getNewFile (JFrame owner, File directory, String extension, String description, int dialogType, boolean updateWorkingDirectory, boolean dirOnly)
specifier|private
specifier|static
name|String
name|getNewFile
...
return|;
block|}
DECL|method|getNewFileImpl (JFrame owner, File directory, String extension, String description, OpenFileFilter off, int dialogType, boolean updateWorkingDirectory, boolean dirOnly, boolean multipleSelection)
specifier|private
specifier|static
name|Object
name|getNewFileImpl
