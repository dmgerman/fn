...
argument_list|)
decl_stmt|;
comment|// Check if a key is already entriesChanged:
if|if
condition|(
operator|(
name|old
...
condition|)
block|{
comment|// Should we check if the file exists?
if|if
condition|(
name|checkExisting
condition|)
...
continue|continue;
block|}
comment|// Otherwise, should we be allowed to overwrite the old link?
elseif|else
if|if
condition|(
operator|!
