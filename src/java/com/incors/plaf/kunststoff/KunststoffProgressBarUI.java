...
begin_comment
comment|/*  * This code was developed by INCORS GmbH (www.incors.com)  * It is published under the terms of the Lesser GNU Public License.  *  * The original class was contributed by  * Julien Ponge  * julien@izforge.com  * http://www.izforge.com/  *  */
end_comment
...
begin_class
DECL|class|KunststoffProgressBarUI
specifier|public
class|class
name|KunststoffProgressBarUI
extends|extends
name|BasicProgressBarUI
block|{
comment|// Creates the UI
...
block|{
comment|// if progress bar is vertical
