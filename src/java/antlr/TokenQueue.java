...
begin_comment
comment|/** A private circular buffer object used by the token buffer */
end_comment

begin_class
DECL|class|TokenQueue
class|class
name|TokenQueue
block|{
...
name|nbrEntries
decl_stmt|;
DECL|method|TokenQueue (int minSize)
specifier|public
name|TokenQueue
parameter_list|(
name|int
...
expr_stmt|;
block|}
comment|/** Remove token from front of queue */
