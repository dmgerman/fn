...
begin_comment
comment|// $ANTLR : "antlr.g" -> "ANTLRParser.java"$
end_comment
...
expr_stmt|;
block|}
DECL|method|reportError (RecognitionException e, String s)
specifier|public
name|void
name|reportError
parameter_list|(
...
literal|null
expr_stmt|;
comment|// RK: prevent certain orders of header actions
comment|// overwriting eachother.
block|}
name|match
argument_list|(
name|LITERAL_header
...
condition|)
block|{
comment|// store the header action
comment|// FIXME: 'n' should be checked for validity
name|behavior
operator|.
...
name|ex
decl_stmt|;
comment|// RK: These probably generate inconsequent error messages...
comment|// have to see how this comes out..
if|if
condition|(
name|e
operator|.
...
argument_list|)
expr_stmt|;
comment|//				System.out.println("warning: line " + lc.getLine() + ": 'lexclass' is deprecated; use 'class X extends Lexer'");
block|}
break|break;
block|}
case|case
...
argument_list|)
expr_stmt|;
comment|//			System.out.println("warning: line " +
comment|//				idTok.getLine() + ": use 'class X extends Parser'");
block|}
break|break;
block|}
default|default:
