...
begin_comment
comment|/** TODO: strip comments from javadoc entries  */
end_comment
...
begin_comment
comment|/**Generate P.sgml, a cross-linked representation of P with or without actions */
end_comment

begin_class
DECL|class|DocBookCodeGenerator
specifier|public
class|class
name|DocBookCodeGenerator
extends|extends
name|CodeGenerator
block|{
...
DECL|method|DocBookCodeGenerator ()
specifier|public
name|DocBookCodeGenerator
parameter_list|()
block|{
...
block|}
comment|/** Encode a string for printing in a HTML document..      * e.g. encode '<' '>' and similar stuff      * @param s the string to encode      */
DECL|method|QuoteForId (String s)
specifier|static
name|String
name|QuoteForId
parameter_list|(
...
name|println
argument_list|(
literal|"<para>Definition of lexer "
operator|+
name|grammar
operator|.
name|getClassName
...
name|println
argument_list|(
literal|"<para>Definition of parser "
operator|+
name|grammar
operator|.
name|getClassName
...
name|println
argument_list|(
literal|"<para>Definition of tree parser "
operator|+
name|grammar
operator|.
name|getClassName
...
name|println
argument_list|(
literal|"<itemizedlist mark=\"none\">"
argument_list|)
expr_stmt|;
for|for
control|(
...
comment|//if ( prevAltElem==null ||
comment|//	 !(prevAltElem instanceof AlternativeBlock) ||
comment|//	 ((AlternativeBlock)prevAltElem).alternatives.size()==1 )
comment|//{
name|_println
argument_list|(
literal|"("
...
name|println
argument_list|(
literal|"<othername></othername>"
argument_list|)
expr_stmt|;
name|println
argument_list|(
literal|"<surname></surname>"
argument_list|)
expr_stmt|;
name|println
argument_list|(
...
name|println
argument_list|(
literal|"    Generated by<ulink url=\"http://www.ANTLR.org/\">ANTLR</ulink>"
operator|+
name|antlrTool
operator|.
name|version
