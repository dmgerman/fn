...
expr_stmt|;
block|}
comment|/** stuff in between #(...) and #id items  * Allow the escaping of the # for C preprocessor stuff.  */
...
argument_list|)
decl_stmt|;
comment|// verify that it's not a preprocessor macro...
if|if
condition|(
name|mapped
operator|!=
...
name|reportWarning
argument_list|(
literal|"\"##\" not valid in this context"
argument_list|)
expr_stmt|;
name|text
operator|.
...
name|t
operator|=
literal|"{ text.erase(_begin); text += "
operator|+
name|a2
operator|.
name|getText
...
name|append
argument_list|(
literal|"text.substr(_begin,text.length()-_begin)"
argument_list|)
expr_stmt|;
block|}
else|else
...
argument_list|)
expr_stmt|;
comment|//			System.out.println("AST_CONSTRUCTOR: "+((x==null)?"null":x.getText())+
comment|//									 ", "+((y==null)?"null":y.getText()));
name|String
name|ys
init|=
name|generator
...
argument_list|)
decl_stmt|;
comment|// the second does not need processing coz it's a string
comment|// (eg second param of astFactory.create(x,y)
if|if
condition|(
name|y
operator|!=
...
argument_list|)
decl_stmt|;
comment|//				System.out.println("mapped: "+id.getText()+" -> "+t);
if|if
condition|(
name|t
operator|!=
