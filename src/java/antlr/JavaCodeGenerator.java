...
begin_comment
comment|/**Generate MyParser.java, MyLexer.java and MyParserTokenTypes.java */
end_comment

begin_class
DECL|class|JavaCodeGenerator
specifier|public
class|class
...
argument_list|()
expr_stmt|;
comment|// print out the grammar with lookahead sets (and FOLLOWs)
comment|// System.out.print(g.toString());
name|exitIfError
argument_list|()
expr_stmt|;
block|}
...
argument_list|)
expr_stmt|;
comment|// Generate header specific to lexer Java file
comment|// println("import java.io.FileInputStream;");
name|println
argument_list|(
literal|"import java.io.InputStream;"
argument_list|)
expr_stmt|;
name|println
argument_list|(
literal|"import antlr.TokenStreamException;"
argument_list|)
expr_stmt|;
name|println
argument_list|(
literal|"import antlr.TokenStreamIOException;"
argument_list|)
expr_stmt|;
name|println
argument_list|(
literal|"import antlr.TokenStreamRecognitionException;"
argument_list|)
expr_stmt|;
name|println
argument_list|(
literal|"import antlr.CharStreamException;"
argument_list|)
expr_stmt|;
name|println
argument_list|(
literal|"import antlr.CharStreamIOException;"
argument_list|)
expr_stmt|;
name|println
argument_list|(
literal|"import antlr.ANTLRException;"
argument_list|)
expr_stmt|;
name|println
argument_list|(
literal|"import java.io.Reader;"
argument_list|)
expr_stmt|;
name|println
argument_list|(
...
name|println
argument_list|(
literal|"import antlr.InputBuffer;"
argument_list|)
expr_stmt|;
name|println
argument_list|(
literal|"import antlr.ByteBuffer;"
argument_list|)
expr_stmt|;
name|println
argument_list|(
literal|"import antlr.CharBuffer;"
argument_list|)
expr_stmt|;
name|println
argument_list|(
literal|"import antlr.Token;"
argument_list|)
expr_stmt|;
name|println
argument_list|(
literal|"import antlr.CommonToken;"
argument_list|)
expr_stmt|;
name|println
argument_list|(
literal|"import antlr.RecognitionException;"
argument_list|)
expr_stmt|;
name|println
argument_list|(
literal|"import antlr.NoViableAltForCharException;"
argument_list|)
expr_stmt|;
name|println
argument_list|(
literal|"import antlr.MismatchedCharException;"
argument_list|)
expr_stmt|;
name|println
argument_list|(
literal|"import antlr.TokenStream;"
argument_list|)
expr_stmt|;
name|println
argument_list|(
literal|"import antlr.ANTLRHashString;"
argument_list|)
expr_stmt|;
name|println
argument_list|(
literal|"import antlr.LexerSharedInputState;"
argument_list|)
expr_stmt|;
name|println
argument_list|(
...
name|println
argument_list|(
literal|"import antlr.SemanticException;"
argument_list|)
expr_stmt|;
...
name|println
argument_list|(
literal|"this(new ByteBuffer(in));"
argument_list|)
expr_stmt|;
name|tabs
operator|--
...
name|println
argument_list|(
literal|"this(new CharBuffer(in));"
argument_list|)
expr_stmt|;
name|tabs
operator|--
...
name|println
argument_list|(
literal|"literals = new Hashtable();"
argument_list|)
expr_stmt|;
name|Enumeration
name|keys
...
name|println
argument_list|(
literal|"literals.put(new ANTLRHashString("
operator|+
name|s
operator|.
name|getId
...
name|println
argument_list|(
literal|"private static final String _ruleNames[] = {"
argument_list|)
expr_stmt|;
name|ids
operator|=
...
name|println
argument_list|(
literal|"import antlr.TokenBuffer;"
argument_list|)
expr_stmt|;
name|println
argument_list|(
...
name|println
argument_list|(
literal|"import antlr.NoViableAltException;"
argument_list|)
expr_stmt|;
name|println
argument_list|(
literal|"import antlr.MismatchedTokenException;"
argument_list|)
expr_stmt|;
name|println
argument_list|(
...
name|println
argument_list|(
literal|"import antlr.ParserSharedInputState;"
argument_list|)
expr_stmt|;
name|println
argument_list|(
...
name|AUTO_GEN_NONE
case|:
comment|// println("theASTFactory.addASTChild(currentAST, returnAST);");
name|println
argument_list|(
...
name|println
argument_list|(
literal|"public static final BitSet "
operator|+
name|getBitsetName
argument_list|(
name|id
...
argument_list|)
expr_stmt|;
comment|// In addition, generate *_AST variables if
comment|// building ASTs
if|if
condition|(
name|grammar
operator|.
...
comment|// predicate in a method translate $ and #
comment|// references
name|ActionTransInfo
name|tInfo
init|=
...
name|println
argument_list|(
literal|"_ttype = testLiteralsTable(new String(text.getBuffer(),_begin,text.length()-_begin),_ttype);"
argument_list|)
expr_stmt|;
block|}
...
name|println
argument_list|(
literal|"public Token nextToken() throws TokenStreamException {"
argument_list|)
expr_stmt|;
name|println
argument_list|(
...
name|println
argument_list|(
literal|"\t\tthrow new TokenStreamException(cse.getMessage());"
argument_list|)
expr_stmt|;
name|println
argument_list|(
...
name|errFinish
init|=
literal|"if (LA(1)==EOF_CHAR) {uponEOF(); _returnToken = makeToken(Token.EOF_TYPE);}"
decl_stmt|;
name|errFinish
operator|+=
name|newline
...
name|errFinish
operator|+=
literal|"else {consume(); continue tryAgain;}"
expr_stmt|;
block|}
else|else
block|{
...
name|println
argument_list|(
literal|"if ( _returnToken==null ) continue tryAgain; // found SKIP token"
argument_list|)
expr_stmt|;
name|println
argument_list|(
...
name|println
argument_list|(
literal|"if ( !getCommitToPath() ) {consume(); continue tryAgain;}"
argument_list|)
expr_stmt|;
block|}
else|else
...
name|println
argument_list|(
literal|"	if ( cse instanceof CharStreamIOException ) {"
argument_list|)
expr_stmt|;
name|println
argument_list|(
...
name|println
argument_list|(
literal|"if (_t!=null) {_t = _t.getNextSibling();}"
argument_list|)
expr_stmt|;
block|}
if|if
...
name|println
argument_list|(
literal|"if ( _createToken&& _token==null&& _ttype!=Token.SKIP ) {"
argument_list|)
expr_stmt|;
name|println
argument_list|(
...
name|println
argument_list|(
literal|"	_token.setText(new String(text.getBuffer(), _begin, text.length()-_begin));"
argument_list|)
expr_stmt|;
name|println
argument_list|(
...
name|println
argument_list|(
literal|"boolean synPredMatched"
operator|+
name|blk
operator|.
name|ID
...
name|println
argument_list|(
literal|"public static final String[] _tokenNames = {"
argument_list|)
expr_stmt|;
name|tabs
operator|++
...
name|println
argument_list|(
literal|"int NULL_TREE_LOOKAHEAD = "
operator|+
name|Token
operator|.
