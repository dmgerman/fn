...
begin_class
DECL|class|ParserGrammar
class|class
name|ParserGrammar
extends|extends
name|Grammar
block|{
DECL|method|ParserGrammar (String className_, Tool tool_, String superClass)
name|ParserGrammar
parameter_list|(
name|String
name|className_
...
parameter_list|()
block|{
comment|// if debugging, choose the debugging version of the parser
if|if
condition|(
name|debuggingOutput
condition|)
return|return
literal|"debug.LLkDebuggingParser"
return|;
return|return
literal|"LLkParser"
return|;
