...
begin_class
DECL|class|SatherBlockFinishingInfo
class|class
name|SatherBlockFinishingInfo
block|{
...
decl_stmt|;
DECL|method|SatherBlockFinishingInfo ()
specifier|public
name|SatherBlockFinishingInfo
parameter_list|()
block|{
...
expr_stmt|;
block|}
DECL|method|SatherBlockFinishingInfo ( String ps, boolean genS, boolean generatedAnIf, boolean n )
specifier|public
name|SatherBlockFinishingInfo
parameter_list|(
name|String
